...
const Books = () => {
  ...
  const books: Book[] = [ 
      ...
      },
    {
      ...
      category: "الأكثر مبيعاً",
      description: "رحلة عاطفية شيقة إلى عالم الحب المجنون حيث تتحطم كل قواعد المنطق، تروي قصة شخصيات تبحث عن الحب في مدينة تختبر صدق مشاعرهم وتكشف عن أعمق أسرار قلوبهم في مواجهة بين العقل والهوى.",
      price: 346,
      priceUSD: 8.4,
      originalPrice: 494,
      originalPriceUSD: 12,
      ...
      title: "خوف 1",
      category: "الأكثر مبيعاً",
      description: "رواية تشويق نفسي مذهلة تدفع بالقارئ إلى أعماق عالم الرعب والغموض، حيث تتحول المخاوف الدفينة إلى كوابيس حقيقية تهدد الوجود نفسه في سلسلة أحداث متلاحقة تختبر حدود الشجاعة البشرية.",
      price: 403,
      priceUSD: 9.8,
      originalPrice: 576,
      originalPriceUSD: 14,
    ...
    },
    {
      ...
      title: "أبادول",
      category: "روايات",
      description: "رواية طبية مشوقة تدمج بين التشويق والمعرفة العلمية، تتبع رحلة طبيب يواجه تحديات مهنية وأخلاقية في عالم الجراحة المعقد، حيث تختلط المشاعر الإنسانية بالمسؤولية الطبية.",
      price: 402,
      priceUSD: 9.75,
      originalPrice: 535,
      originalPriceUSD: 13,
    ...
    },
    {
      ...
      title: "أرض السافلين",
      category: "روايات",
      description: "غوص في أعماق المجتمع المصري عبر قصة تشريحية تكشف التناقضات الطبقية والصراعات الخفية، حيث تتصادم الأخلاق مع الواقع في معركة وجودية من أجل البقاء والكرامة.",
      price: 340,
      priceUSD: 8.25,
      originalPrice: 453,
      originalPriceUSD: 11,
    ...
    },
    {
      ...
      category: "روايات",
      description: "دراما نفسية آسية تروي معاناة امرأة عالقة في علاقة سامة، تبحث عن الحرية بين قيود المجتمع والتقاليد، في رحلة اكتشاف الذات والتحرر من الأصفاد invisible.",
      price: 494.25,
      priceUSD: 12,
      originalPrice: 659,
      originalPriceUSD: 16,
    ...
    },
    {
      ...
      title: "أماريتا",
      category: "روايات",
      description: "ملحمة تاريخية تجمع بين الواقع والخيال في عالم الفانتازيا العربية، تتبع أسطورة مملكة قديمة وأسرارها المدفونة، حيث تتصارع القوى الغامضة من أجل السيطرة على مصير البشر.",
      price: 309,
      priceUSD: 7.5,
      originalPrice: 412,
      originalPriceUSD: 10,
    ...
    },
    {
      ...
      title: "أمانوس",
      category: "روايات",
      description: "إثارة طبية تدور في أروقة المستشفيات، حيث يجد طبيب شاب نفسه في مواجهة مؤامرة خطيرة تهدد حياة المرضى، في سباق مع الزمن لكشف الحقيقة وإنقاذ الأبرياء.",
      price: 309,
      priceUSD: 7.5,
      originalPrice: 412,
      originalPriceUSD: 10,
    ...
    },
    {
      ...
      title: "أمواج أكما",
      category: "روايات",
      description: "مغامرة بحرية شيقة إلى عالم الجزر الغامضة والكنوز المفقودة، تتبع رحلة بحار شاب يكتشف أسرار محيط مجهول وقوى خفية تتحدى قوانين الطبيعة والفيزياء.",
      price: 309,
      priceUSD: 7.5,
      originalPrice: 412,
      originalPriceUSD: 10,
    ...
    },
    {
      ...
      title: "أوبال",
      category: "روايات",
      description: "قصة غموض طبية حول حجر كريم غامض يحمل قوى خارقة، تتبع عالمة جيولوجيا في رحلة خطيرة لكشف أسراره بين المختبرات السرية والمنظمات الغامضة التي تتقاتل على امتلاكه.",
      price: 309,
      priceUSD: 7.5,
      originalPrice: 412,
      originalPriceUSD: 10,
    ...
    },
    {
      ...
      title: "إيكادولي",
      category: "روايات",
      description: "دراما إنسانية عميقة تروي قصة طبيبة تواجه تحديًا وجوديًا بين مهنتها النبيلة وحياتها الشخصية، في رحلة تبحث فيها عن التوازن بين العقل والقلب، العلم والإنسانية.",
      price: 309,
      priceUSD: 7.5,
      originalPrice: 412,
      originalPriceUSD: 10,
    ...
    },
    {
      ...
      title: "الشيطان يحكي",
      category: "روايات",
      description: "رواية فلسفية جريئة تقدم رؤية مختلفة للشر والخير، حيث يحكي الشيطان قصته من وجهة نظره، متحديًا المفاهيم التقليدية للأخلاق والدين والإنسانية في حوار وجودي مثير.",
      price: 370.5,
      priceUSD: 9,
      originalPrice: 449,
      originalPriceUSD: 12,
    ...
    },
    {
      ...
      title: "القصر الأحمر",
      category: "روايات",
      description: "دراما تاريخية آسية تدور في بلاط الإمبراطورية الصينية، تروي قصة امرأة قوية تتحدى التقاليد من أجل السلطة والحب، في عالم من المؤامرات والخيانات والصراعات الدموية.",
      price: 401.25,
      priceUSD: 9.75,
      originalPrice: 535,
      originalPriceUSD: 13,
    ...
    },
    {
      ...
      title: "الهلكوت",
      category: "روايات",
      description: "نهاية العالم كما لم تُروَ من قبل، ملحمة ما بعد الكارثة تتبع ناجين يواجهون عالمًا جديدًا قاسيًا، حيث تختبر البشرية حدودها الأخلاقية في معركة من أجل البقاء.",
      price: 309,
      priceUSD: 7.5,
      originalPrice: 412,
      originalPriceUSD: 10,
    ...
    },
    {
      ...
      title: "بيت خالتي",
      category: "روايات",
      description: "رحلة إلى عمق الذاكرة والهوية، تروي قصة عائلة فلسطينية عبر الأجيال، حيث يتحول بيت العائلة إلى رمز للانتماء والصمود في وجه النكبات والتشتت والمنفى.",
      price: 432,
      priceUSD: 10.5,
      originalPrice: 576,
      originalPriceUSD: 14,
    ...
    },
    {
      ...
      title: "دقات الشامو",
      category: "روايات",
      description: "غموض مصري قديم يتفجر في العصر الحديث، تتبع عالم آثار في رحلة خطيرة لكشف أسرار حضارة مفقودة وطقوس غامضة تهدد بإيقاظ قوى شريرة كانت نائمة لآلاف السنين.",
      price: 309,
      priceUSD: 7.5,
      originalPrice: 412,
      originalPriceUSD: 10,
    ...
    },
    {
      ...
      title: "ربيع الأندلس",
      category: "روايات",
      description: "إحياء لعصر الذهبي في الأندلس، تروي قصة شاعر وفتاة من خلفيات مختلفة في زمن التعايش والحضارة، حيث يزهر الحب بينما تتهدد الممالك بالإندثار.",
      price: 370.5,
      priceUSD: 9,
      originalPrice: 494,
      originalPriceUSD: 12,
    ...
    },
    {
      ...
      title: "سُقُطرى",
      category: "روايات",
      description: "مغامرة إلى الجزيرة الأسطورية ذات الطبيعة الساحرة، تتبع باحثة شابة في رحلة لاكتشاف نباتات نادرة وأسرار علاجية، لكنها تكتشف أن الجزيرة تخفي أكثر من مجرد نباتات.",
      price: 370.5,
      priceUSD: 9,
      originalPrice: 494,
      originalPriceUSD: 12,
    ...
    },
    {
      ...
      title: "سيرٌّوش",
      category: "روايات",
      description: "دراما طبية عن طبيبة شابة تواجه تحديًا غير متوقع عندما تكتشف مؤامرة دوائية كبرى، مجبرة على الاختيار بين صمتها حمايةً لمستقبلها أو كشف الحقيقة وإنقاذ الأرواح.",
      price: 309,
      priceUSD: 7.5,
      originalPrice: 412,
      originalPriceUSD: 10,
    ...
    },
    {
      ...
      category: "روايات",
      description: "المجموعة الكاملة لأعظم قصص المحقق الأسطوري، من لغز الطقوس الأربعة إلى كلب آل باسكرفيل، في رحلة عبر العقل التحليلي الذي غير مفهوم الأدب البوليسي forever.",
      price: 2961.75,
      priceUSD: 72,
      originalPrice: 3949,
      originalPriceUSD: 96,
    ...
    },
    {
      ...
      title: "شيفرة بلال",
      category: "روايات",
      description: "رحلة في عالم التكنولوجيا والهوية الإسلامية، تتبع مبرمجًا شابًا يطور تطبيقًا ثوريًا لكنه يجد نفسه في مواجهة تحديات أخلاقية وتقنية تختبر إيمانه وإنسانيته.",
      price: 339.75,
      priceUSD: 8.25,
      originalPrice: 453,
      originalPriceUSD: 11,
    ...
    },
    {
      ...
      title: "فتى الأندلس",
      category: "روايات",
      description: "ملحمة تاريخية عن طفل نشأ في قرطبة الذهبية، يشهد ازدهار الحضارة الإسلامية وانحدارها، في رحلة نمو تختبر الإيمان والعلم والحب في زمن التحولات الكبرى.",
      price: 339.75,
      priceUSD: 8.25,
      originalPrice: 453,
      originalPriceUSD: 11,
    ...
    },
    {
      ...
      title: "قربان آل يونس",
      category: "روايات",
      description: "دراما عائلية عميقة تكشف أسرار عائلة تخفي ماضيًا مظلمًا، حيث تتصادم الأجيال وتنكشف الخيانات في قصة عن الإرث والمسؤولية وثمن الحقيقة المؤلمة.",
      price: 401.25,
      priceUSD: 9.75,
      originalPrice: 535,
      originalPriceUSD: 13,
    ...
    },
    {
      ...
      title: "قواعد جارتين",
      category: "روايات",
      description: "كوميديا رومانسية عن جارتين مختلفتين تمامًا تجمعهما الصدفة في نفس العمارة، في علاقة تتحول من المنافسة إلى الصداقة ثم إلى شيء أعمق، في قصة عن التقبل والتفاهم.",
      price: 309,
      priceUSD: 7.5,
      originalPrice: 412,
      originalPriceUSD: 10,
    ...
    },
    {
      ...
      title: "كُوِيكُول",
      category: "روايات",
      description: "غموض علمي حول دواء تجريبي يحمل وعودًا بالشفاء لكنه يخفي آثارًا جانبية مرعبة، تتبع طبيبة شجاعة في بحثها عن الحقيقة التي قد تكلفها حياتها المهنية وحتى حياتها.",
      price: 309,
      priceUSD: 7.5,
      originalPrice: 412,
      originalPriceUSD: 10,
    ...
    },
    {
      ...
      category: "روايات",
      description: "استمرار لمغامرات المتجر السحري الذي يبيع الأحلام، حيث يواجه صاحب المتجر تحديات جديدة وأسرارًا أعمق عن طبيعة الأحلام وتأثيرها على الواقع ومصير البشر.",
      price: 339.75,
      priceUSD: 8.25,
      originalPrice: 453,
      originalPriceUSD: 11,
    ...
    },
    {
      ...
      category: "روايات",
      description: "فانتازيا ساحرة عن متجر غامض يبيع أحلامًا حقيقية، تتبع زبائن من خلفيات مختلفة يشترون أحلامهم لكنهم يكتشفون أن لكل حلم ثمنًا يجب دفعه، في قصة عن الأماني والتضحية.",
      price: 309,
      priceUSD: 7.5,
      originalPrice: 412,
      originalPriceUSD: 10,
    ...
    },
    {
      ...
      title: "ملائك نصيبين",
      category: "روايات",
      description: "دراما إنسانية عن مدينة على الحدود تئن تحت وطأة الحرب، تروي قصص أناس عاديين يصبحون أبطالًا في زمن الدمار، حيث تختبر الإنسانية أقسى اختباراتها وأجملها.",
      price: 370.5,
      priceUSD: 9,
      originalPrice: 494,
      originalPriceUSD: 12,
    ...
    },
    {
      ...
      title: "واحة اليعقوب",
      category: "روايات",
      description: "رحلة إلى صحراء الجزيرة العربية بحثًا عن واحة أسطورية، تتبع مستكشفًا شابًا يكتشف ليس فقط الواحة المفقودة ولكن أيضًا أسرارًا عن أسلافه وتراثه الضائع.",
      price: 309,
      priceUSD: 7.5,
      originalPrice: 412,
      originalPriceUSD: 10,
      ...
      author: "عمرو عبدالحmيد"
    },
    {
      id: 31,
      title: "أرض زيكولا",
      category: "روايات",
      description: "فانتازيا épique عن عالم موازٍ يحكمه سحر قديم، تتبع أميرة شابة في رحلة لاستعادة عرشها من غازٍ شرير، مستعينة بقوى خفية وحيوانات أسطورية في معركة مصيرية.",
      price: 309,
      priceUSD: 7.5,
      originalPrice: 412,
      originalPriceUSD: 10,
    ...
    },
    {
      ...
      category: "روايات",
      description: "مغامرة في برية سيبيريا القاسية، تتبع عالم أحياء في رحلة لدراسة ذئاب نادرة، لكنه يكتشف أن الوادي يحمل أسرارًا عن الطبيعة والإنسان أكثر غموضًا مما توقع.",
      price: 309,
      priceUSD: 7.5,
      originalPrice: 412,
      originalPriceUSD: 10,
    ...
    },
    {
      ...
      title: "شوجن",
      category: "روايات",
      description: "ملحمة تاريخية ضخمة عن اليابان الإقطاعية، تروي قصة samurai شاب يصعد من الظلام إلى النور في رحلة تتخللها المعارك الدامية والمكائد السياسية وتعاليم Bushido.",
      price: 1080.75,
      priceUSD: 26.25,
      originalPrice: 1441,
      originalPriceUSD: 35,
    ...
    },
  {
    ...
    title: "خوف 1",
    category: "روايات",
    description: "بداية سلسلة رعب نفسي مذهلة تدفع القارئ إلى حافة الهاوية، حيث تتحول المخاوف اليومية إلى كوابيس حية تهدد العقل والروح في مواجهة مع قوى شريرة لا ترحم.",
    price: 403,
    priceUSD: 9.8,
    originalPrice: 576,
    originalPriceUSD: 14,
  ...
  },
  {
    ...
    title: "خوف 2",
    category: "روايات",
    description: "استمرار للرعب المتصاعد حيث تتعمق الكوابيس وتتكشف الألغاز، في جزء يدفع بالشخصيات إلى حدود المجهول حيث يصبح الخوف حقيقة ملموسة والهروب مستحيلاً.",
    price: 403,
    priceUSD: 9.8,
    originalPrice: 576,
    originalPriceUSD: 14,
  ...
  },
  {
    ...
    title: "خوف 3",
    category: "روايات",
    description: "الختام المروع للسلسلة التي أعادت تعريف الرعب العربي، حيث تصل الأحداث إلى ذروتها في مواجهة مصيرية تختبر حدود القوة البشرية أمام الظلام المطلق.",
    price: 403,
    priceUSD: 9.8,
    originalPrice: 576,
    originalPriceUSD: 14,
  ...
  },
  {
    ...
    category: "روايات",
    description: "ملحمة تاريخية عن أرض الأحلام والصراعات، تروي قصة مملكة قديمة تائهة بين الواقع والأسطورة، حيث تتقاتل العائلات المالكة على عرش من ذهب وتراب من دماء.",
    price: 519,
    priceUSD: 12.6,
    originalPrice: 741,
    originalPriceUSD: 18,
  ...
  },
  {
    ...
    category: "روايات",
    description: "استمرار للمواجهة الملحمية بين الخير والشر، حيث تتصاعد المعركة إلى مستويات كونية وتتكشف أسرار أقدم من الزمن نفسه في صراع يحدد مصير البشرية.",
    price: 519,
    priceUSD: 12.6,
    originalPrice: 741,
    originalPriceUSD: 18,
  ...
  },
  {
    ...
    title: "لُجّ 1",
    category: "روايات",
    description: "غوص في أعماق المحيط والروح البشرية، تروي قصة بحارة يواجهون أسرار أعماق البحار وقوى خفية تتحدى قوانين الطبيعة والمنطق في رحلة لا عودة منها.",
    price: 519,
    priceUSD: 12.6,
    originalPrice: 741,
    originalPriceUSD: 18,
  ...
  },
  {
    ...
    category: "روايات",
    description: "سيرة ذاتية روائية مذهلة تكشف عن رحلة شخصية عبر الألم والشفاء، تروي تحولات الحياة من الظلام إلى النور في قصة تمس شغاف القلب وتلامس الأعماق.",
    price: 519,
    priceUSD: 12.6,
    originalPrice: 741,
    originalPriceUSD: 18,
  ...
  },
  {
    ...
    category: "روايات",
    description: "النسخة الزرقاء من القصة المؤثرة، تقدم رؤية مختلفة لأحداث متشابكة حيث يصبح اللون الأزرق رمزاً للأمل والحكمة في رحلة البحث عن الذات والحرية.",
    price: 519,
    priceUSD: 12.6,
    originalPrice: 741,
    originalPriceUSD: 18,
  ...
  },
  {
    ...
    category: "روايات",
    description: "النسخة الصفراء التي تمثل الضوء والتحذير، تروي القصة من منظور جديد حيث يصبح اللون الأصفر دليلاً على التحول والانطلاق نحو آفاق غير متوقعة.",
    price: 519,
    priceUSD: 12.6,
    originalPrice: 741,
    originalPriceUSD: 18,
  ...
  },
  {
    ...
    category: "روايات",
    description: "النسخة السوداء الأكثر عمقاً وغموضاً، تكشف عن الطبقات المخفية من القصة حيث يرمز الأسود إلى الجذور والأسرار والبدايات الجديدة من رحم الظلام.",
    price: 519,
    priceUSD: 12.6,
    originalPrice: 741,
    originalPriceUSD: 18,
  ...
  },
  {
    ...
    title: "مدينة الحب لا يسكنها العقلاء ج1",
    category: "روايات",
    description: "بداية رومانسية مجنونة في مدينة حيث الحب يحكم والعقلاء يهربون، تروي قصة شخصيات تبحث عن الحب الحقيقي في مكان يختبر صدق المشاعر ونقاء القلوب.",
    price: 346,
    priceUSD: 8.4,
    originalPrice: 494,
    originalPriceUSD: 12,
  ...
  },
  {
    ...
    category: "روايات",
    description: "استمرار للقصة الرومانسية العميقة التي تبحث عن الجمال في التفاصيل الصغيرة، حيث يكتشف الأبطال أن الحب الحقيقي هو رحلة اكتشاف مستمرة للذات والآخر.",
    price: 346,
    priceUSD: 8.4,
    originalPrice: 494,
    originalPriceUSD: 12,
  ...
  },
  {
    ...
    title: "أبابيل 1",
    category: "روايات",
    description: "ملحمة خيالية عن طيور أسطورية تحمل أسرار الكون، تروي قصة شاب يكتشف أنه الحلقة المفقودة في معركة قديمة بين قوى الخير والشر التي تتجسد في شكل طيور مقدسة.",
    price: 416,
    priceUSD: 11.2,
    originalPrice: 659,
    originalPriceUSD: 16,
  ...
  },
  {
    ...
    title: "الجساسة 2",
    category: "روايات",
    description: "الجزء الثاني من المغامرة المثيرة حيث تتعمق أسرار الكائنات الأسطورية وتتوسع الرقعة الجغرافية لمواجهة أعداء جدد وأسرار أكثر خطورة من الخيال.",
    price: 416,
    priceUSD: 11.2,
    originalPrice: 659,
    originalPriceUSD: 16,
  ...
  },
  {
    ...
    title: "جومانا",
    category: "روايات",
    description: "قصة امرأة قوية تتحدى التقاليد والقوى الظلامية في رحلة بحث عن هويتها المفقودة، تثبت فيها أن القوة الحقيقية تكمن في الإرادة والتصميم.",
    price: 416,
    priceUSD: 11.2,
    originalPrice: 659,
    originalPriceUSD: 16,
    ...
    author: "أحمد آل حمدan"
  },
  {
    id: 49,
    title: "آرسس 1",
    category: "روايات",
    description: "بداية ملحمة خيال علمي مذهلة عن كوكب جديد وحضارة متطورة، تروي قصة مستكشفين يواجهون لغزاً كونياً يتحدى كل ما يعرفونه عن العلم والوجود.",
    price: 403,
    priceUSD: 9.8,
    originalPrice: 576,
    originalPriceUSD: 14,
  ...
  },
  {
    ...
    title: "آرسس 2",
    category: "روايات",
    description: "استمرار للمغامرة الكونية حيث تتصاعد الأحداث إلى مستويات مجرية، ويكتشف الأبطال أنهم جزء من خطة كونية أكبر مما توقعوا في أي لحظة.",
    price: 403,
    priceUSD: 9.8,
    originalPrice: 576,
    originalPriceUSD: 14,
  ...
  },
  {
    ...
    title: "آزر",
    category: "روايات",
    description: "دراما إنسانية عن أب يواجه أصعب الاختيارات بين duty وعاطفته، في قصة تمس شغاف القلب عن التضحية والحب الأبوي غير المشروط.",
    price: 416,
    priceUSD: 11.2,
    originalPrice: 659,
    originalPriceUSD: 16,
  ...
  },
  {
    ...
    title: "ايكارا",
    category: "روايات",
    description: "رحلة إلى عالم الأساطير اليونانية القديمة، تروي قصة بطلة شابة تتحدى الآلهة من أجل حريتها في ملحمة تجمع بين الخيال والتاريخ والفلسفة.",
    price: 403,
    priceUSD: 9.8,
    originalPrice: 576,
    originalPriceUSD: 14,
  ...
  },
  {
    ...
    category: "روايات",
    description: "غموض بوليسي مثير حول عشاء يجمع أصدقاء قدامى، لكنه يتحول إلى كابوس عندما يكتشفون أن بينهم قاتلاً في قصة تشويق تضع القارئ في قلب الأحداث.",
    price: 346,
    priceUSD: 8.4,
    originalPrice: 494,
    originalPriceUSD: 12,
  ...
  },
  {
    ...
    title: "بيت الخناس",
    category: "روايات",
    description: "رعب نفسي عُماني أصيل عن بيت مسكون بأرواح شريرة، تروي قصة عائلة تواجه كائنات خفية تهدد ليس فقط حياتهم ولكن أرواحهم أيضاً.",
    price: 432,
    priceUSD: 10.5,
    originalPrice: 617,
    originalPriceUSD: 15,
  ...
  },
  {
    ...
    title: "بيت الخناس ج2",
    category: "روايات",
    description: "استمرار للرعب المتصاعد حيث تتعمق لعنة البيت وتتكشف أسرار أكثر ظلمة عن الماضي المدفوع والعلاقات المعقدة بين الأحياء والأموات.",
    price: 432,
    priceUSD: 10.5,
    originalPrice: 617,
    originalPriceUSD: 15,
  ...
  },
  {
    ...
    title: "005",
    category: "روايات",
    description: "إثارة وجاسوسية عن عميلة سرية تحمل الرقم 005، تروي مهمتها الخطيرة في عالم الظل حيث تخاطر بحياتها من أجل حماية وطنها من تهديد وجودي.",
    price: 432,
    priceUSD: 10.5,
    originalPrice: 617,
    originalPriceUSD: 15,
  ...
  },
  {
    ...
    title: "ستوكهولم",
    category: "روايات",
    description: "دراما نفسية عن متلازمة ستوكهولم تروي قصة رهينة تطور مشاعر غريبة تجاه مختطفها في علاقة معقدة تختبر حدود العقل والقلب والإرادة.",
    price: 432,
    priceUSD: 10.5,
    originalPrice: 617,
    originalPriceUSD: 15,
  ...
  },
  {
    ...
    title: "البارون",
    category: "روايات",
    description: "قصة عن سيدة أعمال قوية تتحول إلى 'البارون' في عالم الرجال، تروي تحدياتها في بناء إمبراطورية تجارية وتوازنها بين القسوة المطلوبة والأنوثة المكبوتة.",
    price: 432,
    priceUSD: 10.5,
    originalPrice: 617,
    originalPriceUSD: 15,
  ...
  },
  {
    ...
    category: "روايات",
    description: "رواية رعب وجودي عن كاتب يجد نفسه عالقاً في دوامة من الخوف والجنون، حيث تتحول الكلمات إلى كوابيس والواقع إلى سجن نفسي لا مفر منه.",
    price: 461,
    priceUSD: 11.2,
    originalPrice: 659,
    originalPriceUSD: 16,
  ...
  },
  {
    ...
    category: "روايات",
    description: "سيرة إبداعية عن قوة الكتابة كوسيلة للتحرر والخلاص، تروي رحلة كاتبة تستخدم الكلمات كسلاح ضد الشياطين الداخلية والخارجية في معركة وجودية.",
    price: 432,
    priceUSD: 10.5,
    originalPrice: 617,
    originalPriceUSD: 15,
  ...
  },
  {
    ...
    title: "بيتشيني",
    category: "روايات",
    description: "كوميديا سوداء عن فتاة غير تقليدية تحمل اسم 'بيتشيني'، تروي تحديها للتوقعات المجتمعية في رحلة بحث عن الذات تجمع بين الفكاهة والجرأة.",
    price: 432,
    priceUSD: 10.5,
    originalPrice: 617,
    originalPriceUSD: 15,
  ...
  },
  {
    ...
    title: "لأنها كيارا",
    category: "روايات",
    description: "قصة حب إيطالية تروي علاقة عابرة للثقافات بين شاب عربي وفتاة إيطالية، في رحلة تبحث عن المعنى الحقيقي للحب الذي يتجاوز كل الحدود والاختلافات.",
    price: 432,
    priceUSD: 10.5,
    originalPrice: 617,
    originalPriceUSD: 15,
  ...
  },
  {
    ...
    category: "روايات",
    description: "فانتازيا شعرية عن مملكة حيث تتحول الأحلام إلى واقع والضباب يخفي عوالم موازية، في رحلة ساحرة تبحث عن الحد الفاصل بين الخيال والحقيقة.",
    price: 432,
    priceUSD: 10.5,
    originalPrice: 617,
    originalPriceUSD: 15,
  ...
  },
  {
    ...
    title: "ساحر أو مجنون",
    category: "روايات",
    description: "رواية تأخذنا في رحلة عميقة إلى عالم الصراع الأزلي بين السحر والعقل، حيث تتداخل الحقيقة مع الخيال في قصة مشوقة تجمع بين الغموض والفلسفة. تطرح الرواية تساؤلات جوهرية حول طبيعة الواقع والوهم، وتستكشف الخط الرفيع الفاصل بين العبقرية والجنون، في سرد يأسر القارئ من الصفحة الأولى حتى النهاية.",
    price: 395,
    priceUSD: 9.60,
    originalPrice: 494,
    originalPriceUSD: 12,
  ...
  },
  {
    ...
    title: "أنا يوسف",
    category: "روايات",
    description: "عمل أدبي مميز يستلهم قصة النبي يوسف عليه السلام، ويقدمها برؤية معاصرة تجمع بين عمق الرسالة الروحية وجمال السرد الأدبي. الرواية تعيد صياغة رحلة الصبر والابتلاء والنجاح بأسلوب يلامس القلب، وتستكشف معاني الصبر والثقة بالله والعفو والمغفرة من خلال شخصية يوسف الملهمة، في قصة خالدة تتجدد مع كل جيل.",
    price: 263,
    priceUSD: 6.40,
    originalPrice: 329,
    originalPriceUSD: 8,
  ...
  },
  {
    ...
    title: "حديث الجنود",
    category: "روايات",
    description: "رواية واقعية تأخذنا إلى عمق الحياة العسكرية، وتكشف عن الجانب الإنساني للجنود خلف البزات الرسمية. تروي قصصاً من واقع الثكنات والمعسكرات، وتصور الصداقات والصراعات والأحلام التي تعتمل في نفوس أولئك الذين اختاروا طريق الدفاع عن الوطن. الرواية تجمع بين الواقعية القاسية والمشاعر الإنسانية العميقة، وتقدم رؤية صادقة للحياة خلف الأسوار العسكرية.",
    price: 263,
    priceUSD: 6.40,
    originalPrice: 329,
    originalPriceUSD: 8,
  ...
  },
  {
    ...
    title: "اسمه أحمد",
    category: "روايات",
    description: "سيرة روائية مؤثرة تحكي قصة شخص يدعى أحمد، في رحلة حياتية مستوحاة من الواقع تجمع بين الكفاح والأمل والإصرار. الرواية تتتبع مسيرة بطلها عبر محطات حياته المختلفة، من الطفولة إلى النضج، وتصور التحديات التي واجهها والانتصارات التي حققها. إنها قصة إنسانية عميقة عن البحث عن الذات والهوية في عالم متغير، وعن القوة الكامنة في الإرادة البشرية.",
    price: 296,
    priceUSD: 7.20,
    originalPrice: 370,
    originalPriceUSD: 9,
  ...
  },
  {
    ...
    title: "نفر من الجن",
    category: "روايات",
    description: "رواية غامضة ومشوقة تأخذنا إلى عالم ما وراء الطبيعة، حيث يتقاطع عالم الإنس مع عالم الجن في أحداث مثيرة ومرعبة. القصة تستكشف الجانب الخفي من الوجود، وتطرح تساؤلات عميقة حول طبيعة العوالم الأخرى وتأثيرها على حياتنا. بأسلوب سردي مشوق يمزج بين الرعب والتشويق والفلسفة، تقدم الرواية تجربة قراءة فريدة تجعل القارئ يعيد النظر في حدود الواقع والخيال.",
    price: 263,
    priceUSD: 6.40,
    originalPrice: 329,
    originalPriceUSD: 8,
  ...
  },
  {
    ...
    title: "رؤوس الشياطين",
    category: "روايات",
    description: "عمل روائي جريء يغوص في أعماق النفس البشرية ويستكشف أفكار الشر والصراع الداخلي الذي يعتمل في قلب الإنسان. الرواية تتناول الجانب المظلم من الطبيعة البشرية، وتصور المعركة الأبدية بين الخير والشر داخل كل منا. بلغة قوية وأسلوب نفسي عميق، تقدم الرواية رحلة مرعبة ومثيرة في متاهات النفس البشرية وأسرارها المخيفة.",
    price: 230,
    priceUSD: 5.60,
    originalPrice: 288,
    originalPriceUSD: 7,
  ...
  },
  {
    ...
    title: "طريق جهنم",
    category: "روايات",
    description: "رحلة روائية خطيرة ومشوقة تأخذنا عبر طريق محفوف بالمخاطر نحو مصير مجهول ومرعب. الرواية تصور رحلة شخصيات تواجه أقسى التحديات والاختبارات في طريقهم المظلم، حيث كل خطوة قد تكون الأخيرة. بأسلوب سردي مثير يجمع بين التشويق والفلسفة، تستكشف الرواية معاني الخطيئة والعقاب والخلاص، وتطرح تساؤلات عميقة حول اختياراتنا ومصائرنا.",
    price: 296,
    priceUSD: 7.20,
    originalPrice: 370,
    originalPriceUSD: 9,
  ...
  },
  {
    ...
    category: "روايات",
    description: "قصة إنسانية مؤثرة عن الصداقة والأمل داخل أسوار السجن القاسية، حيث تنمو العلاقات الإنسانية في أقسى الظروف. الرواية تصور حياة السجناء اليومية، صراعاتهم الداخلية، وكيف يجدون في الصداقة والأمل سبيلاً للبقاء والصمود. إنها شهادة على قوة الروح الإنسانية وقدرتها على الصمود والنمو حتى خلف القضبان، وعن كيف يمكن للصداقة أن تكون نوراً في أحلك الظروف.",
    price: 263,
    priceUSD: 6.40,
    originalPrice: 329,
    originalPriceUSD: 8,
  ...
  },
  {
    ...
    title: "مسغبة",
    category: "روايات",
    description: "رواية عميقة تعبر عن حالات الشغب والفوضى الداخلية التي تعتري النفس البشرية في لحظات الأزمات. القصة تستكشف الصراع النفسي والاجتماعي، وتصور كيف يمكن للفوضى الداخلية أن تنعكس على العالم الخارجي. بأسلوب أدبي راقٍ ولغة شاعرية، تأخذنا الرواية في رحلة عبر متاهات النفس المضطربة، وتقدم رؤية عميقة للصراع الإنساني مع الذات والمجتمع.",
    price: 296,
    priceUSD: 7.20,
    originalPrice: 370,
    originalPriceUSD: 9,
  ...
  },
  {
    ...
    title: "تسعة عشر",
    category: "روايات",
    description: "قصة غامضة ومثيرة تحيط بها هالة من الغموض والأسرار المحيرة، حيث يحمل الرقم تسعة عشر دلالات ورموزاً عميقة. الرواية تنسج خيوط حبكتها بعناية فائقة، وتقدم ألغازاً متشابكة تتطلب من القارئ التفكير والتأمل. إنها رحلة استكشافية في عالم مليء بالرموز والإشارات، حيث كل تفصيل قد يكون مفتاحاً لحل اللغز الأكبر، في تجربة قراءة تجمع بين التشويق والعمق الفلسفي.",
    price: 263,
    priceUSD: 6.40,
    originalPrice: 329,
    originalPriceUSD: 8,
  ...
  },
  {
    ...
    title: "خاوية",
    category: "روايات",
    description: "رواية فلسفية عميقة تتناول موضوع الفراغ الداخلي والبحث الحثيث عن المعنى في عالم مادي. القصة تتتبع رحلة شخصيات تعاني من الخواء الروحي، وتبحث عن ملء الفراغ الذي يعتريها. بأسلوب تأملي وشاعري، تستكشف الرواية الأسئلة الوجودية الكبرى، وتقدم رؤية عميقة لأزمة الإنسان المعاصر في بحثه عن المعنى والهدف والاتصال الحقيقي بذاته وبالعالم من حوله.",
    price: 263,
    priceUSD: 6.40,
    originalPrice: 329,
    originalPriceUSD: 8,
  ...
  },
  {
    ...
    title: "كلمة الله",
    category: "روايات",
    description: "قصة روحانية عميقة تبحث عن الحقيقة المطلقة والكلمة الإلهية التي تنير طريق البشرية. الرواية تأخذنا في رحلة بحث فلسفي وروحاني عن جوهر الإيمان والمعرفة الحقيقية. من خلال شخصيات تسعى لفهم معنى الوجود والغاية من الحياة، تقدم الرواية تأملات عميقة في طبيعة الإيمان والشك، وتستكشف العلاقة بين الإنسان والخالق في سرد فلسفي مؤثر.",
    price: 230,
    priceUSD: 5.60,
    originalPrice: 288,
    originalPriceUSD: 7,
  ...
  },
  {
    ...
    title: "يوم مشهود",
    category: "روايات",
    description: "رواية مشوقة عن يوم استثنائي سيغير كل شيء ويعيد تشكيل مصائر الشخصيات بشكل جذري. القصة تدور حول أحداث يوم واحد، لكنه يوم مليء بالتحولات الدرامية والمواقف المصيرية التي تترك أثراً عميقاً على حياة الجميع. بسرد مكثف ومتسارع، تستكشف الرواية كيف يمكن ليوم واحد أن يحمل من الأحداث ما يكفي لتغيير مسار حياة بأكملها، في قصة تجمع بين التشويق والعمق الإنساني.",
    price: 263,
    priceUSD: 6.40,
    originalPrice: 329,
    originalPriceUSD: 8,
  ...
  },
  {
    ...
    title: "يسمعون حسيسها",
    category: "روايات",
    description: "قصة مستوحاة من النصوص الدينية عن يوم القيامة وأهواله، تصور المشاهد المهيبة لذلك اليوم العظيم. الرواية تأخذنا في رحلة تأملية عبر أحداث الآخرة، حيث يسمع الناس حسيس النار وأصوات العذاب. بأسلوب أدبي مؤثر يجمع بين الرهبة والخشوع، تقدم الرواية تصويراً حياً لمشاهد البعث والحساب، وتدعو القارئ للتأمل في مصيره الأخروي والاستعداد لذلك اليوم المشهود.",
    price: 263,
    priceUSD: 6.40,
    originalPrice: 329,
    originalPriceUSD: 8,
  ...
  },
  {
    ...
    title: "ذائقة الموت",
    category: "روايات",
    description: "رواية فلسفية عميقة تتناول تجارب الاقتراب من الموت وتأثيرها العميق على النفس البشرية. القصة تستكشف لحظات الاحتضار والتجارب الروحانية التي يمر بها من يقتربون من الموت ثم يعودون للحياة. من خلال شهادات وتجارب متنوعة، تقدم الرواية رؤية عميقة لمعنى الحياة والموت، وتطرح أسئلة وجودية حول طبيعة الوعي والروح والآخرة، في سرد يجمع بين الواقعية والتأمل الفلسفي.",
    price: 263,
    priceUSD: 6.40,
    originalPrice: 329,
    originalPriceUSD: 8,
  ...
  },
  {
    ...
    title: "ليطمئن قلبي",
    category: "روايات",
    description: "قصة روحانية مؤثرة عن البحث عن الطمأنينة والسكينة والإيمان الحقيقي في عالم مضطرب. الرواية تتتبع رحلة شخصيات تسعى لملء الفراغ الروحي في حياتها، وتبحث عن الإجابات لأسئلتها الوجودية. من خلال سرد يجمع بين الواقعية والروحانية، تقدم الرواية تجربة قراءة تلامس القلب وتثير التأمل، وتدعو القارئ للبحث عن الطمأنينة الحقيقية التي لا تتحقق إلا بالإيمان العميق والاتصال بالله.",
    price: 395,
    priceUSD: 9.60,
    originalPrice: 494,
    originalPriceUSD: 12,
  ...
  },
  {
    ...
    title: "نطفة",
    category: "روايات",
    description: "رواية فلسفية عميقة تتناول موضوع أصل الحياة والخلق، وتستكشف رحلة الإنسان منذ بدايته الأولى كنطفة. القصة تأخذنا في رحلة علمية وروحانية عبر مراحل تكوين الإنسان، وتتأمل في عظمة الخلق والإبداع الإلهي. بأسلوب يجمع بين العلم والأدب والفلسفة، تقدم الرواية رؤية شاملة لمعجزة الحياة، وتدعو القارئ للتفكر في عظمة الخالق وإتقان صنعه، في سرد يجمع بين الإعجاز العلمي والتأمل الروحاني.",
    price: 395,
    priceUSD: 9.60,
    originalPrice: 494,
    originalPriceUSD: 12,
  ...
  },
  {
    ...
    title: "نبض",
    category: "روايات",
    description: "قصة إنسانية عميقة تتناول مشاعر الحب والإنسانية النابضة في قلب كل منا. الرواية تستكشف النبض الإنساني الذي يربطنا ببعضنا البعض، وتصور العواطف والمشاعر التي تجعلنا بشراً. من خلال حكايات متشابكة عن الحب والخسارة والأمل، تقدم الرواية صورة صادقة للتجربة الإنسانية بكل تعقيداتها وجمالها. إنها احتفاء بالحياة والمشاعر والعلاقات التي تعطي معنى لوجودنا.",
    price: 395,
    priceUSD: 9.60,
    originalPrice: 494,
    originalPriceUSD: 12,
  ...
  },
  {
    ...
    category: "روايات",
    description: "رحلة خيالية مبدعة تأخذنا للقاء أحد أشهر الشخصيات في التاريخ الإسلامي، الفاروق عمر بن الخطاب رضي الله عنه. الرواية تقدم حواراً خيالياً معاصراً مع هذه الشخصية التاريخية العظيمة، وتستكشف قيمه ومبادئه وحكمته من خلال عيون راوٍ معاصر. بأسلوب سردي مشوق يجمع بين التاريخ والخيال، تقدم الرواية دروساً قيّمة في العدل والقيادة والإيمان، وتربط بين الماضي العظيم والحاضر المعاصر.",
    price: 395,
    priceUSD: 9.60,
    originalPrice: 494,
    originalPriceUSD: 12,
  ...
  },
  {
    ...
    title: "ثاني اثنين",
    category: "روايات",
    description: "قصة روائية ملهمة عن الصحابي الجليل أبو بكر الصديق رضي الله عنه، ثاني اثنين في الغار. الرواية تصور حياة الصديق وصداقته العميقة مع النبي صلى الله عليه وسلم، وتستكشف إيمانه الراسخ وتضحياته الجسيمة من أجل الإسلام. من خلال سرد يجمع بين الدقة التاريخية والإبداع الأدبي، تقدم الرواية صورة حية لهذه الشخصية العظيمة، وتبرز قيم الصداقة والإخلاص والتضحية والإيمان الذي لا يتزعزع.",
    price: 370,
    priceUSD: 9.00,
    originalPrice: 494,
    originalPriceUSD: 12,
  ...
  },
  {
    ...
    title: "حطمني",
    category: "روايات",
    description: "رواية عاطفية قوية ومؤثرة تحكي عن تجربة قاسية أدت إلى تحطم داخلي عميق للشخصية الرئيسية. القصة تستكشف آثار الصدمات العاطفية والنفسية على الروح البشرية، وتصور رحلة الألم والانكسار والبحث عن طريق للتعافي. بلغة شاعرية مؤثرة وأسلوب سردي يلامس القلب، تقدم الرواية تجربة قراءة مؤلمة وشفائية في آن واحد، وتعبر عن مشاعر الفقدان والانكسار بصدق وعمق يجعلها تلامس كل من مر بتجربة مشابهة.",
    price: 370,
    priceUSD: 9.00,
    originalPrice: 494,
    originalPriceUSD: 12,
  ...
  },
  {
    ...
    title: "فسرني",
    category: "روايات",
    description: "قصة عاطفية معقدة تبحث عن تفسير للحب والحياة وكل ما بينهما من مشاعر وأحاسيس. الرواية تغوص في أعماق العلاقات الإنسانية، وتحاول فك شفرة المشاعر المعقدة التي تربطنا ببعضنا البعض. من خلال شخصيات تسعى لفهم نفسها وفهم الآخرين، تقدم الرواية رحلة استكشافية في عالم العواطف الإنسانية. بأسلوب سردي جميل ولغة شاعرية، تأخذنا الرواية في رحلة لاكتشاف معاني الحب والفقدان والأمل والبحث عن المعنى.",
    price: 462,
    priceUSD: 11.25,
    originalPrice: 617,
    originalPriceUSD: 15,
  ...
  },
  {
    ...
    title: "أشعلني",
    category: "روايات",
    description: "رواية رومانسية ملتهبة عن شغف وحب يلهب المشاعر ويأسر القلوب. القصة تصور علاقة عاطفية قوية ومتوهجة، مليئة بالمشاعر الجياشة والانجذاب الذي لا يقاوم. من خلال شخصيتين تجمعهما كيمياء استثنائية، تقدم الرواية قصة حب مليئة بالعاطفة والتوتر والانفعالات. بأسلوب سردي جذاب ولغة تنبض بالحياة، تأخذنا الرواية في رحلة عاطفية مثيرة تستكشف قوة الحب وقدرته على إشعال النار في القلوب وتحويل الحياة.",
    price: 432,
    priceUSD: 10.50,
    originalPrice: 576,
    originalPriceUSD: 14,
  ...
  },
  {
    ...
    title: "أن تبقى",
    category: "روايات",
    description: "قصة ملهمة عن التحدي والإصرار على البقاء والصمود في وجه الصعاب والمحن. الرواية تتتبع رحلة شخصيات تواجه تحديات هائلة تهدد وجودها، لكنها تختار البقاء والمقاومة. من خلال سرد مؤثر يصور قوة الإرادة البشرية وعزيمة الإنسان على الاستمرار رغم كل شيء، تقدم الرواية شهادة على قدرة الروح البشرية على الصمود والتغلب على أقسى الظروف. إنها قصة عن الأمل والقوة والإصرار على الحياة.",
    price: 370,
    priceUSD: 9.00,
    originalPrice: 494,
    originalPriceUSD: 12,
  ...
  },
  {
    ...
    title: "أفراح المقبرة",
    category: "روايات",
    description: "رواية مرعبة ومثيرة من أدب الرعب والفانتازيا، تدور أحداثها في أجواء مظلمة وغامضة داخل مقبرة قديمة. القصة تمزج بين الرعب النفسي والخارق للطبيعة، وتصور أحداثاً غريبة ومرعبة تحدث في هذا المكان الموحش. بأسلوب سردي مشوق يتقن الكاتب فيه خلق أجواء الرعب والتوتر، تقدم الرواية تجربة قراءة مخيفة ومثيرة تجعل القارئ يشعر بالقشعريرة. إنها رحلة في عالم الظلام والأشباح والأسرار المدفونة التي تنتظر من يكشفها.",
    price: 308,
    priceUSD: 7.50,
    originalPrice: 411,
    originalPriceUSD: 10,
  ...
  },
  {
    ...
    title: "رفقاء الليل",
    category: "روايات",
    description: "مجموعة من الحكايات الغامضة والمرعبة التي تدور في ظلام الليل الحالك. الرواية تقدم سلسلة من القصص المترابطة عن شخصيات تواجه مخلوقات وظواهر غريبة في ساعات الليل المتأخرة. بأسلوب سردي يتقن خلق أجواء الرعب والغموض، تأخذنا الرواية في رحلة مخيفة عبر عوالم مظلمة مليئة بالأسرار والمفاجآت. كل قصة تحمل رسالة وعبرة، وتستكشف المخاوف البشرية العميقة في سرد يجمع بين الرعب والتشويق والحكمة.",
    price: 308,
    priceUSD: 7.50,
    originalPrice: 411,
    originalPriceUSD: 10,
  ...
  },
  {
    ...
    title: "ياسمين العودة",
    category: "روايات",
    description: "قصة عاطفية عميقة عن العودة إلى الجذور والذات واكتشاف الهوية الحقيقية. الرواية تتتبع رحلة بطلتها ياسمين التي تعود إلى مسقط رأسها بعد سنوات من الغياب، لتواجه ماضيها وتعيد اكتشاف نفسها. من خلال سرد يجمع بين الواقعية والعاطفة، تستكشف الرواية موضوعات الانتماء والذاكرة والهوية والعلاقات العائلية. بلغة شاعرية جميلة وأسلوب سردي مؤثر، تقدم الرواية تجربة قراءة غنية عن رحلة العودة إلى الذات والجذور.",
    price: 493,
    priceUSD: 12.00,
    originalPrice: 658,
    originalPriceUSD: 16,
  ...
  },
  {
    ...
    category: "روايات",
    description: "مغامرة خيالية ساحرة في عالم سحري مذهل تحت الماء، حيث تعيش كائنات بحرية خرافية وأسرار غامضة. القصة تتبع رحلة فتاة شجاعة في أعماق بحر الزمرد الأسطوري، حيث تواجه تحديات هائلة وتكتشف عوالم مدهشة. بخيال واسع وقدرة استثنائية على بناء العوالم الفانتازية، يقدم الكاتب ملحمة خيالية مليئة بالسحر والمغامرة والشخصيات المثيرة. الرواية تجمع بين الإثارة والجمال والعمق، وتأخذ القارئ في رحلة لا تُنسى عبر عوالم لم يرَ مثلها.",
    price: 740,
    priceUSD: 18.00,
    originalPrice: 987,
    originalPriceUSD: 24,
  ...
  },
  {
    ...
    title: "سماء بلا ضياء",
    category: "روايات",
    description: "رواية عميقة ومؤثرة عن اليأس والأمل في ظلام الأوقات الصعبة، حيث تبدو السماء خالية من النور. القصة تصور حياة شخصيات تمر بأحلك الظروف وأقسى الابتلاءات، وتبحث عن بصيص أمل في ظلام دامس. من خلال سرد إنساني عميق يلامس القلب، تستكشف الرواية موضوعات الصمود والإيمان والأمل في وجه اليأس. بلغة شاعرية مؤثرة، تقدم الرواية رسالة قوية عن قدرة الإنسان على إيجاد النور حتى في أحلك الظروف.",
    price: 493,
    priceUSD: 12.00,
    originalPrice: 658,
    originalPriceUSD: 16,
  ...
  },
  {
    ...
    title: "لغز بربروسا",
    category: "روايات",
    description: "مغامرة تاريخية مثيرة للكشف عن لغز القرصان البحري الأسطوري بربروسا وكنوزه المفقودة. الرواية تجمع بين التاريخ والخيال في سرد مشوق يأخذنا عبر البحار والمحيطات في رحلة بحث محفوفة بالمخاطر. من خلال شخصيات جريئة تسعى لكشف أسرار هذا القرصان الشهير، تقدم الرواية مزيجاً مثيراً من التشويق والتاريخ والمغامرة. القصة مليئة بالألغاز والمفاجآت والمطاردات، وتعيد إحياء حقبة القراصنة الذهبية بأسلوب سردي جذاب.",
    price: 308,
    priceUSD: 7.50,
    originalPrice: 411,
    originalPriceUSD: 10,
    ...
    author: "جهاد التُّرباني"
  },
  {
    id: 94,
    title: "حرب الفاندال",
    category: "روايات",
    description: "رواية تاريخية ملحمية عن صراع إمبراطوريات قديمة وحروب دموية غيرت مجرى التاريخ. القصة تأخذنا إلى حقبة الفاندال، إحدى القبائل الجرمانية الشهيرة، وتصور حروبهم وفتوحاتهم وصراعاتهم مع الإمبراطورية الرومانية. بدقة تاريخية وخيال أدبي، يعيد الكاتب بناء هذه الحقبة المهمة من التاريخ، ويقدم شخصيات حية ومعارك ملحمية وأحداثاً درامية. الرواية تجمع بين المتعة والمعرفة التاريخية في سرد يأسر القارئ من أول صفحة.",
    price: 308,
    priceUSD: 7.50,
    originalPrice: 411,
    originalPriceUSD: 10,
  ...
  },
  {
    ...
    title: "سر آريوس",
    category: "روايات",
    description: "قصة تشويق تاريخية للكشف عن سر عقيدة آريوس القديمة والصراعات اللاهوتية التي هزت المسيحية المبكرة. الرواية تأخذنا في رحلة عبر الزمن لاستكشاف إحدى أكثر الجدالات الدينية إثارة في التاريخ. من خلال شخصيات تسعى لكشف الحقيقة المخفية، تمزج الرواية بين التاريخ والغموض والمغامرة. بأسلوب سردي مشوق وأحداث متسارعة، تقدم الرواية رؤية مثيرة لفترة تاريخية حاسمة، مع ألغاز ومؤامرات تجعل القارئ في حالة ترقب مستمر.",
    price: 308,
    priceUSD: 7.50,
    originalPrice: 411,
    originalPriceUSD: 10,
  ...
  },
  {
    ...
    category: "روايات",
    description: "رواية ملحمية عن الصراع المصيري والفصل الأخير في حرب طويلة غيرت مصير الأمم. القصة تصور المعركة الحاسمة التي ستحدد مصير كل الأطراف المتنازعة، في سرد درامي مشحون بالتوتر والإثارة. من خلال شخصيات متعددة من جوانب مختلفة من الصراع، تقدم الرواية رؤية شاملة للحرب وآثارها على الأفراد والمجتمعات. بأسلوب ملحمي يجمع بين الحركة والعمق الإنساني، تأخذنا الرواية في رحلة عبر أهوال الحرب وبطولات الإنسان.",
    price: 308,
    priceUSD: 7.50,
    originalPrice: 411,
    originalPriceUSD: 10,
  ...
  },
  {
    ...
    title: "العملية 101",
    category: "روايات",
    description: "قصة تشويق مثيرة عن مهمة سرية وخطيرة يقوم بها فريق نخبة في ظروف استثنائية. الرواية تأخذنا في رحلة مليئة بالتوتر والمفاجآت، حيث كل خطوة قد تكون الفارق بين النجاح والفشل، بين الحياة والموت. من خلال أحداث متسارعة وشخصيات معقدة، تقدم الرواية مزيجاً مثيراً من الحركة والتشويق والمغامرة. بأسلوب سردي محكم يحافظ على التوتر حتى النهاية، تجعل الرواية القارئ في حالة ترقب مستمر، متسائلاً عن نتيجة هذه العملية الخطيرة.",
    price: 308,
    priceUSD: 7.50,
    originalPrice: 411,
    originalPriceUSD: 10,
  ...
  },
  {
    ...
    title: "ألف ليلة وليلة",
    category: "روايات",
    description: "عمل أدبي تراثي عظيم يضم مئات القصص الشعبية والأسطورية الخالدة، تدور في إطار حكايات شهرزاد الساحرة للملك شهريار. يجمع بين المغامرات الشيقة مثل رحلات السندباد البحري السبع، والأساطير الخالدة مثل علاء الدين والمصباح السحري وعلي بابا والأربعين حرامي، وقصص الحب والخيانة والملوك والجن والسحر. هذا العمل الأدبي الضخم يعد من أبرز روائع الأدب العالمي وأحد أكثر الكتب تأثيرًا في المخيلة الإنسانية عبر العصور، وقد ألهم أجيالاً من الكتاب والفنانين في مختلف أنحاء العالم. كل ليلة تحمل قصة جديدة مليئة بالحكمة والمغامرة والعجائب.",
    price: 1605,
    priceUSD: 39,
    originalPrice: 2140,
    originalPriceUSD: 52,
    ...
    },
    {
      ...
      title: "نمر الليل",
      category: "روايات",
      description: "رواية مليئة بالإثارة والتشويق تأخذنا إلى عالم الجريمة والظلام في مدينة لا تنام أبداً. القصة تتبع نمراً ماكراً من عالم الجريمة المنظمة، يتحرك في الظلام وينفذ عملياته بدقة متناهية. من خلال أحداث متسارعة وشخصيات معقدة تعيش على حافة القانون، تقدم الرواية صورة واقعية وقاسية لعالم الإجرام. بأسلوب سردي مشوق يجمع بين الإثارة والغموض، وبحبكة محكمة مليئة بالمفاجآت، تأخذنا الرواية في رحلة مظلمة عبر شوارع المدينة الليلية وأسرارها الخطيرة.",
      price: 376,
      priceUSD: 9.10,
      originalPrice: 537,
      originalPriceUSD: 13,
    ...
    },
    {
      ...
      category: "روايات",
      description: "قصة إنسانية مؤثرة تجمع بين الحلم والواقع على جسر الجمهورية الشهير، حيث تتقاطع مصائر شخصيات متنوعة. الرواية تصور لحظات حاسمة في حياة أناس عاديين يقفون فوق الجسر، كل منهم يحمل قصته وأحلامه ومخاوفه. من خلال سرد إنساني عميق يستكشف الأمل واليأس والحب والفقدان، تقدم الرواية صورة صادقة للحياة المعاصرة. بأسلوب شاعري جميل ولغة تلامس القلب، تأخذنا الرواية في رحلة عاطفية عبر حيوات متشابكة على هذا الجسر الرمزي.",
      price: 347,
      priceUSD: 8.40,
      originalPrice: 496,
      originalPriceUSD: 12,
    ...
    },
    {
      ...
      category: "روايات",
      description: "رواية معقدة ومتعددة الطبقات تتناول حياة مجموعة من الشخصيات المثيرة للاهتمام على مدى عقود. القصة تتتبع صداقات وعلاقات تبدأ في أيام الشباب وتمتد عبر السنين، مع تحولاتها ومفاجآتها. من خلال شخصيات غنية ومعقدة، كل منها يحمل أسراره وأحلامه وإخفاقاته، تقدم الرواية بانوراما واسعة للحياة المعاصرة. بأسلوب سردي ذكي وعميق، تستكشف الرواية موضوعات الصداقة والطموح والحب والخيانة والنجاح والفشل، في عمل أدبي طموح يأسر القارئ بثراء شخصياته وعمق رؤيته.",
      price: 521,
      priceUSD: 12.60,
      originalPrice: 744,
      originalPriceUSD: 18,
    ...
    },
    {
      ...
      title: "من قتل والدي",
      category: "روايات",
      description: "رحلة بحث مشوقة ومحفوفة بالمخاطر للكشف عن حقيقة مقتل الأب في جريمة غامضة. الرواية تتبع ابن الضحية في سعيه المحموم لكشف القاتل وفهم الملابسات المعقدة المحيطة بالجريمة. من خلال تحقيق دقيق يكشف طبقات من الأسرار والأكاذيب، تقدم الرواية قصة تشويق محكمة مليئة بالمفاجآت. بأسلوب سردي متوتر ومشوق، وبحبكة معقدة تجمع بين الغموض والدراما العائلية، تأخذنا الرواية في رحلة للبحث عن الحقيقة والعدالة في قصة مؤلمة عن الفقد والانتقام.",
      price: 173,
      priceUSD: 4.20,
      originalPrice: 248,
      originalPriceUSD: 6,
    ...
    },
    {
      ...
      category: "روايات",
      description: "قصة خيالية كلاسيكية وخالدة عن جاك الصبي الفقير ومغامرته الرائعة مع ساق الفاصوليا السحرية. الحكاية تروي كيف يتسلق جاك هذه الساق العملاقة ليصل إلى عالم سحري في السماء، حيث يواجه عملاقاً ضخماً ويعيش مغامرات مثيرة. هذه الرواية المترجمة بعناية تقدم واحدة من أشهر حكايات الأطفال في العالم، محملة بالدروس والعبر عن الشجاعة والذكاء. بأسلوب سردي بسيط وجذاب يناسب جميع الأعمار، تأخذنا هذه القصة الخالدة في رحلة خيالية لا تُنسى.",
      price: 173,
      priceUSD: 4.20,
      originalPrice: 248,
      originalPriceUSD: 6,
    ...
    },
    {
      ...
      title: "قبل أدم",
      category: "روايات",
      description: "رواية خيال علمي رائدة تستكشف عوالم ما قبل الخليقة والإنسان، وتأخذنا في رحلة عبر الزمن إلى عصور ما قبل التاريخ. القصة تروي ذكريات رجل يحلم بحياته في جسد سلف بشري بدائي، ويعيش تجارب أسلافه القدماء. من خلال هذا السرد المبتكر، يستكشف جاك لندن نظرية التطور والذاكرة الجينية بطريقة أدبية مبدعة. بخيال علمي جريء وأسلوب سردي قوي، تقدم الرواية رؤية فريدة لأصول الإنسان وتطوره، في عمل يجمع بين المغامرة والفلسفة والعلم.",
      price: 231,
      priceUSD: 5.60,
      originalPrice: 330,
      originalPriceUSD: 8,
    ...
    },
    {
      ...
      title: "عين الجمل",
      category: "روايات",
      description: "قصة تراثية عميقة وخالدة تحمل معاني إنسانية راقية وقيمًا اجتماعية نبيلة من آسيا الوسطى. الرواية تصور حياة قرية صغيرة وسكانها البسطاء، وتستكشف علاقتهم بالطبيعة والتقاليد والقيم الإنسانية الأصيلة. من خلال شخصيات حية ومؤثرة، يقدم الكاتب الشهير أيتماتوف رؤية عميقة للحياة البشرية والصراع بين التقاليد والحداثة. بلغة شاعرية جميلة وحكمة عميقة، تأخذنا الرواية في رحلة تأملية عن معنى الحياة والانتماء والهوية، في عمل أدبي يستحق أن يُقرأ ويُعاد قراءته.",
      price: 173,
      priceUSD: 4.20,
      originalPrice: 248,
      originalPriceUSD: 6,
    ...
    },
    {
      ...
      category: "روايات",
      description: "قصة غامضة ومثيرة للقلق عن فتاة صغيرة تدعى استيلا تسمع أصواتًا غريبة ومخيفة تأتي من خزانة غرفتها. الرواية تستكشف الخط الرفيع بين الخيال والواقع، بين المخاوف الطفولية والأخطار الحقيقية. من خلال عيون استيلا البريئة، نعيش تجربة مرعبة تجمع بين الرعب النفسي والغموض. بأسلوب سردي مشوق يحافظ على التوتر، وبقدرة على خلق أجواء مخيفة، تقدم الرواية قصة تجعل القارئ يتساءل: هل الأصوات حقيقية أم مجرد خيال طفلة؟",
      price: 289,
      priceUSD: 7.00,
      originalPrice: 413,
      originalPriceUSD: 10,
    ...
    },
    {
      ...
      category: "روايات",
      description: "رواية شعرية حالمة عن الهروب إلى عالم الطبيعة الساحر والسكون الجميل بعيداً عن صخب المدينة. القصة تصور رحلة داخلية للبحث عن السلام والهدوء في أحضان الطبيعة، حيث حقول الكرز تصبح ملاذاً للروح المتعبة. من خلال لغة شاعرية وصور بصرية جميلة، يرسم الكاتب لوحة أدبية ساحرة عن الجمال الطبيعي والصفاء الداخلي. بأسلوب تأملي هادئ يدعو للسكينة، تقدم الرواية تجربة قراءة مريحة ومُلهمة عن العودة إلى البساطة والطبيعة.",
      price: 289,
      priceUSD: 7.00,
      originalPrice: 413,
      originalPriceUSD: 10,
    ...
    },
    {
      ...
      title: "حجر السعادة",
      category: "روايات",
      description: "قصةٌ تتناول رحلةً غامضة في عالمٍ يختلط فيه الواقع بالأسطورة، حيث ينطلق شابٌّ تائه في دروب الحياة بحثًا عن السعادة التي طالما راوغته، ليجد نفسه أمام حجرٍ سحريٍّ يُقال إنه يجلب الحظ لكل من يلمسه. لكن ما يبدأ كرحلةٍ نحو الحظ يتحوّل إلى صراعٍ مع الذات، بين الإيمان بالقَدَر والرغبة في تغييره، وبين الوهم والحقيقة، حتى يكتشف أن السعادة التي كان يطلبها في حجرٍ كانت تسكن قلبه منذ البداية، تنتظر أن يراها بعينٍ لا يغشاها الطمع ولا الخوف.",
      price: 347,
      priceUSD: 8.40,
      originalPrice: 496,
      originalPriceUSD: 12,
    ...
    },
    {
      ...
      title: "اخف من الحلم",
      category: "روايات",
      description: "رواية رقيقة ومؤثرة عن العلاقات الإنسانية الهشة والخيالات التي تكون أخف وزناً من الحلم نفسه. القصة تستكشف طبيعة العلاقات العاطفية الرقيقة التي تبدو أحياناً وكأنها غير حقيقية، خفيفة لدرجة أنها قد تتبخر في أي لحظة. من خلال شخصيات تعيش على حافة بين الواقع والخيال، بين الحب والوهم، تقدم الرواية تأملات عميقة في طبيعة المشاعر الإنسانية. بلغة شاعرية رقيقة وحساسية أدبية عالية، تأخذنا الرواية في رحلة عاطفية تلامس أعماق القلب وتثير التساؤلات حول حقيقة ما نشعر به.",
      price: 289,
      priceUSD: 7.00,
      originalPrice: 413,
      originalPriceUSD: 10,
    ...
    },
    {
      ...
      title: "الابله الرائع",
      category: "روايات",
      description: "قصة عميقة ومؤثرة عن شخصية بسيطة وساذجة ظاهرياً تحمل في طياتها حكمة غير متوقعة وعمقاً إنسانياً نادراً. الرواية تتحدى مفاهيمنا عن الذكاء والحكمة، وتقدم بطلاً غير تقليدي يرى العالم بعيون مختلفة. من خلال تفاعلاته مع المجتمع الذي يسخر منه ثم يكتشف قيمته الحقيقية، تستكشف الرواية موضوعات الحكم المسبق والقيمة الإنسانية الحقيقية. بأسلوب سردي يجمع بين البساطة والعمق، تقدم الرواية رسالة قوية عن أن الحكمة الحقيقية قد تأتي من أكثر الأماكن غير المتوقعة.",
      price: 347,
      priceUSD: 8.40,
      originalPrice: 496,
      originalPriceUSD: 12,
    ...
    },
    {
      ...
      title: "سدهارتا",
      category: "روايات",
      description: "رواية فلسفية روحانية كلاسيكية عن رحلة البحث عن الذات والمعنى الروحي والاستنارة الحقيقية. القصة تتبع سدهارتا، شاب هندي يترك حياة الراحة والامتياز للبحث عن الحقيقة والتنوير. عبر رحلته الطويلة، يجرب أنماط حياة مختلفة - من التقشف الزاهد إلى الحياة الدنيوية - بحثاً عن المعنى. من خلال لقاءاته وتجاربه وتأملاته، يكتشف طريقه الخاص نحو الاستنارة. بلغة شاعرية عميقة وحكمة شرقية أصيلة، تقدم رواية هيرمان هسه الخالدة تأملات عميقة في معنى الحياة والوجود، في عمل أدبي روحاني يستمر في إلهام القراء عبر الأجيال.",
      price: 202,
      priceUSD: 4.90,
      originalPrice: 289,
      originalPriceUSD: 7,
    ...
    },
    {
      ...
      category: "روايات",
      description: "كلاسيكية أدب الأطفال الخالدة عن مغامرات حيوانات رائعة في عالم طبيعي ساحر ومليء بالمفاجآت والصداقة. القصة تتبع مغامرات الخلد، الفأر المائي، الغرير، والضفدع السيد تود في ريف إنجليزي جميل. من خلال مغامراتهم اليومية، لقاءاتهم بشخصيات غريبة، ومواجهاتهم لتحديات متنوعة، تستكشف الرواية موضوعات الصداقة والشجاعة والولاء والمنزل. بأسلوب سردي دافئ ولغة شاعرية تصور جمال الطبيعة، تقدم هذه الرواية الكلاسيكية تجربة قراءة ساحرة تناسب جميع الأعمار وتبقى محفورة في الذاكرة.",
      price: 289,
      priceUSD: 7.00,
      originalPrice: 413,
      originalPriceUSD: 10,
    ...
    },
    {
      ...
      title: "عين زجاجية",
      category: "روايات",
      description: "قصة غامضة ومثيرة تدور حول عين زجاجية غامضة تحمل أسراراً خطيرة وقوى خارقة للطبيعة. الرواية تتبع شخصيات تجد نفسها متورطة في لغز هذه العين الغريبة، والتي يبدو أنها ترى ما لا يراه الآخرون. من خلال أحداث مشوقة تجمع بين الغموض والرعب والإثارة، تستكشف الرواية أسرار هذا الشيء الغريب وتأثيره على من يمتلكونه. بأسلوب سردي مشوق يحافظ على التوتر والغموض، تقدم الرواية قصة تشويق فريدة تجمع بين الواقعية والخيال في سرد يأسر القارئ من البداية للنهاية.",
      price: 202,
      priceUSD: 4.90,
      originalPrice: 289,
      originalPriceUSD: 7,
    ...
    },
    {
      ...
      title: "لسان بورخيس",
      category: "روايات",
      description: "رواية أدبية متميزة تستلهم عالم الكاتب الأرجنتيني الأسطوري خورخي لويس بورخيس وأسلوبه السردي الفريد. القصة تأخذنا في رحلة عبر متاهات الكتابة والخيال والواقع، مستلهمة أسلوب بورخيس في المزج بين الفلسفة والأدب والميتافيزيقيا. من خلال سرد معقد يلعب بالزمن والمكان والهوية، تقدم الرواية تجربة قراءة فكرية غنية. بلغة أدبية راقية وبنية سردية مبتكرة، تقدم هذه الرواية تحية لأحد عمالقة الأدب العالمي، وتدعو القارئ للتأمل في طبيعة الكتابة والخيال والحقيقة.",
      price: 231,
      priceUSD: 5.60,
      originalPrice: 330,
      originalPriceUSD: 8,
    ...
    },
    {
      ...
      title: "أميرة صغيرة",
      category: "روايات",
      description: "قصة كلاسيكية خالدة ومؤثرة عن فتاة غنية ومدللة تدعى سارة تفقد كل شيء بعد وفاة والدها، لكنها تحافظ على كبريائها وكرامتها الإنسانية. الرواية تتبع تحول سارة من أميرة مدللة في مدرسة داخلية راقية إلى خادمة فقيرة تعيش في العلية، ولكنها رغم كل المعاناة والإذلال تبقى محافظة على أخلاقها العالية ولطفها وخيالها الغني. من خلال هذه القصة المؤثرة، تستكشف الرواية موضوعات الكرامة الإنسانية، القوة الداخلية، والشرف الحقيقي الذي لا يعتمد على المال أو المكانة. بأسلوب سردي دافئ ومؤثر، تقدم هذه الكلاسيكية دروساً قيمة عن الصمود والإنسانية.",
      price: 376,
      priceUSD: 9.10,
      originalPrice: 537,
      originalPriceUSD: 13,
    ...
    },
    {
      ...
      category: "روايات",
      description: "كلاسيكية خالدة من أدب الأطفال العالمي عن مغامرات الدب المحبوب ويني بووه وأصدقائه في غابة المئة فدان الساحرة. القصة تتبع ويني بووه المحب للعسل وأصدقاءه - الخنزير الصغير بيجليت، الحمار إيور الكئيب، النمر تيجر المفعم بالحيوية، والحكيم أول البومة - في مغامرات يومية بسيطة ومليئة بالحكمة. من خلال قصص بسيطة ولكن عميقة، تستكشف الرواية موضوعات الصداقة والولاء واللطف والقبول. بأسلوب سردي دافئ وبسيط، ولغة شعرية جميلة، تقدم هذه الكلاسيكية تجربة قراءة ساحرة تناسب جميع الأعمار وتبقى محفورة في القلب.",
      price: 260,
      priceUSD: 6.30,
      originalPrice: 372,
      originalPriceUSD: 9,
    ...
    },
    {
      ...
      title: "نهاية المطاف",
      category: "روايات",
      description: "رحلة عاطفية عميقة ومؤثرة تنتهي عند نقطة مصيرية حاسمة تغير حياة الشخصيات بشكل جذري وكامل. الرواية تتبع شخصيات متعددة في رحلاتهم المختلفة نحو نهايات مصيرية، حيث كل القرارات والاختيارات السابقة تتقاطع في لحظة واحدة حاسمة. من خلال سرد عاطفي عميق يستكشف معاني النهايات والبدايات، والخسارة والاكتشاف، تقدم الرواية تأملات عميقة في طبيعة الحياة ومساراتها. بأسلوب أدبي راقٍ ولغة مؤثرة، تأخذنا الرواية في رحلة تأملية عن معنى الوصول إلى نهاية مطاف ما، وما يمكن أن يعنيه ذلك للروح البشرية.",
      price: 347,
      priceUSD: 8.40,
      originalPrice: 496,
      originalPriceUSD: 12,
    ...
    },
    {
      ...
      title: "رحلات غلفر",
      category: "روايات",
      description: "رواية خيالية ساخرة كلاسيكية عن رحلات الطبيب البحري ليموئيل غلفر المذهلة إلى بلاد العمالقة والأقزام وأمم غريبة أخرى. القصة تأخذنا في أربع رحلات استثنائية: إلى ليليبوت بلاد الأقزام، إلى بروبدنغناج أرض العمالقة، إلى لابوتا الجزيرة الطائرة، وإلى بلاد الخيول العاقلة. من خلال هذه المغامرات الخيالية، يقدم سويفت نقداً لاذعاً للمجتمع والسياسة والطبيعة البشرية. بأسلوب ساخر ذكي يجمع بين الخيال الجامح والنقد الاجتماعي العميق، تبقى هذه الرواية الكلاسيكية عملاً خالداً يثير التفكير ويسلي القارئ في آن واحد.",
      price: 376,
      priceUSD: 9.10,
      originalPrice: 537,
      originalPriceUSD: 13,
    ...
    },
    {
      ...
      category: "روايات",
      description: "مغامرة تاريخية مشوقة للكشف عن مخطوطة سرية مفقودة للرحالة الشهير ابن بطوطة، تحتوي على أسرار خطيرة لم تُذكر في رحلته المعروفة. الرواية تجمع بين الماضي والحاضر، حيث يسعى باحثون معاصرون لكشف هذه المخطوطة الغامضة التي قد تغير فهمنا للتاريخ. من خلال رحلة محفوفة بالمخاطر تمتد عبر بلدان متعددة، وتواجه مؤامرات ومطاردات، تقدم الرواية مزيجاً مثيراً من التاريخ والمغامرة والغموض. بأسلوب سردي جذاب يجمع بين الدقة التاريخية والخيال الأدبي، تأخذنا الرواية في رحلة مثيرة عبر الزمن والمكان.",
      price: 405,
      priceUSD: 9.80,
      originalPrice: 578,
      originalPriceUSD: 14,
    ...
    },
    {
      ...
      category: "روايات",
      description: "قصة كلاسيكية قوية ومؤثرة عن ذئب هجين بين ذئب بري وكلب، يتعلم البقاء في البرية القاسية ثم في عالم البشر. الرواية تتبع رحلة حياة هذا الذئب منذ ولادته في البرية الكندية الباردة، عبر تجاربه المختلفة مع الإنسان - من القسوة والعنف إلى اللطف والحب. من خلال عيون ذي الناب الأبيض، نرى صراع البقاء في الطبيعة، وتعقيدات العلاقة بين الإنسان والحيوان. بأسلوب جاك لندن القوي والواقعي، تقدم هذه الرواية الكلاسيكية تأملات عميقة في الطبيعة البشرية والحيوانية، في قصة مؤثرة عن الصمود والولاء والفداء.",
      price: 289,
      priceUSD: 7.00,
      originalPrice: 413,
      originalPriceUSD: 10,
    ...
    },
    {
      ...
      title: "الشرطي الثالث",
      category: "روايات",
      description: "قصة بوليسية غامضة وسريالية مع وجود شرطي ثالث غامض يحمل مفاجآت غير متوقعة وأحداثاً غريبة. الرواية تأخذنا إلى عالم غريب حيث الواقع يختلط بالخيال، والمنطق يتصادم مع اللامعقول. من خلال حبكة معقدة مليئة بالألغاز والتقلبات غير المتوقعة، تقدم الرواية تجربة قراءة فريدة تتحدى توقعات القارئ. بأسلوب سردي مبتكر يجمع بين الفكاهة السوداء والفلسفة الوجودية والغرابة، تقدم هذه الرواية الأيرلندية الكلاسيكية تجربة أدبية لا تُنسى تترك القارئ في حالة من الذهول والتساؤل.",
      price: 318,
      priceUSD: 7.70,
      originalPrice: 454,
      originalPriceUSD: 11,
    ...
    },
    {
      ...
      title: "غريزة الطير",
      category: "روايات",
      description: "رواية شاعرية عميقة عن الحرية والهجرة والانتماء، مستوحاة من غريزة الطيور المهاجرة في البحث عن موطن أفضل. القصة تستخدم استعارة هجرة الطيور لاستكشاف تجربة الهجرة الإنسانية والشوق للوطن والبحث عن الأمان. من خلال شخصيات تشعر بنداء داخلي للحركة والبحث عن مكان أفضل، تقدم الرواية تأملات عميقة في معاني الوطن والغربة والانتماء. بلغة شاعرية جميلة وصور بصرية مؤثرة، تأخذنا الرواية في رحلة عاطفية وفكرية تستكشف الروابط العميقة بين الإنسان والطبيعة والمكان.",
      price: 347,
      priceUSD: 8.40,
      originalPrice: 496,
      originalPriceUSD: 12,
    ...
    },
    {
      ...
      title: "الأمير احتجاب",
      category: "روايات",
      description: "قصة فلسفية عميقة عن أمير يختار العيش في عزلة واحتجاب عن العالم الخارجي الصاخب، بحثاً عن حقيقة أعمق. الرواية تستكشف أسباب هذا الاختيار الغريب وتأثيره على الأمير وعلى من حوله. من خلال تأملات الأمير المنعزل ولقاءاته النادرة مع زواره، تطرح الرواية أسئلة عميقة عن معنى السلطة والحرية والسعادة والانعزال. بأسلوب سردي تأملي وفلسفي، تقدم الرواية رؤية فريدة لصراع الإنسان مع ذاته ومع العالم، وعن البحث عن المعنى في عالم مليء بالضوضاء والفوضى.",
      price: 260,
      priceUSD: 6.30,
      originalPrice: 372,
      originalPriceUSD: 9,
    ...
    },
    {
      ...
      title: "رجل وحيد",
      category: "روايات",
      description: "قصة مؤثرة وصادقة عن عزلة الإنسان وصراعه العميق مع وحدته القاتلة في العالم الحديث المزدحم. الرواية تصور حياة رجل يجد نفسه وحيداً رغم وجوده وسط الملايين، معزولاً عاطفياً ونفسياً عن المجتمع من حوله. من خلال سرد داخلي عميق يستكشف أفكار ومشاعر هذا الرجل، تقدم الرواية صورة صادقة لأزمة الوحدة المعاصرة. بلغة بسيطة ولكن مؤثرة، وبصدق إنساني نادر، تتناول الرواية موضوعاً يلامس الكثيرين في عصرنا - الشعور بالعزلة والانفصال رغم كل وسائل الاتصال الحديثة.",
      price: 231,
      priceUSD: 5.60,
      originalPrice: 330,
      originalPriceUSD: 8,
    ...
    },
    {
      ...
      title: "صوفيا بتروفنا",
      category: "روايات",
      description: "قصة إنسانية مؤثرة ومفجعة عن أم محبة تحاول بكل قوتها إنقاذ ابنها البريء في ظل ظروف قاسية وقمع شديد. الرواية تصور حياة موظفة بسيطة في الاتحاد السوفييتي إبان عهد ستالين، التي تنقلب حياتها رأساً على عقب عندما يُعتقل ابنها الوحيد بتهم ملفقة. من خلال رحلتها المؤلمة عبر متاهة البيروقراطية والقمع السياسي، تقدم الرواية شهادة قوية على قسوة الأنظمة الاستبدادية وتأثيرها على الأفراد العاديين. بأسلوب بسيط ولكن مؤثر جداً، تقدم هذه الرواية قصة حب أمومي يتحدى الظلم في شهادة إنسانية خالدة.",
      price: 231,
      priceUSD: 5.60,
      originalPrice: 330,
      originalPriceUSD: 8,
    ...
    },
    {
      ...
      category: "روايات",
      description: "قصة قصيرة رائعة للكاتب الروسي العظيم تشيخوف عن رحلة صيد بسيطة تتحول إلى دراما إنسانية عميقة وغير متوقعة. كما هو معهود في أعمال تشيخوف، تبدأ القصة بموقف عادي وبسيط، لكنها تكشف تدريجياً عن طبقات معقدة من المشاعر الإنسانية والعلاقات المتوترة. من خلال أسلوبه الماهر في رصد التفاصيل الصغيرة والنفسيات المعقدة، يحول تشيخوف رحلة صيد عادية إلى تأمل عميق في الطبيعة البشرية. بلغة بسيطة ولكن عميقة المعنى، تقدم هذه القصة درساً في كيفية تحويل اللحظات العادية إلى أدب خالد.",
      price: 289,
      priceUSD: 7.00,
      originalPrice: 413,
      originalPriceUSD: 10,
    ...
    },
    {
      ...
      title: "بيت من ورق",
      category: "روايات",
      description: "رواية تشويقية مذهلة تنسج خيوطاً معقدة من الغموض حول مخطوطات قديمة وأسرار عائلية مدفونة، حيث تتحول صفحات الكتب إلى مفاتيح لكشف حقائق مظلمة ستغير حياة الشخصيات إلى الأبد.",
      price: 350,
      priceUSD: 8.40,
      originalPrice: 500,
      originalPriceUSD: 12,
    ...
    },
    {
      ...
      category: "روايات",
      description: "رحلة استثنائية في عالم الخيال والواقع تروي قصة بحار فقد بصره لكنه اكتشف رؤى داخلية أعمق، في حكاية فلسفية عن إدراك العالم beyond الحواس الخمس وتجاوز حدود الإعاقة الجسدية.",
      price: 379,
      priceUSD: 9.10,
      originalPrice: 542,
      originalPriceUSD: 13,
      discount: 30,
      image: "/book-images/Novels/Nbook181.jpg",
      author: "بثينة العيسى"
    },
    {
      id: 187,
      title: "أسفار مدينة الطين 1/3",
      category: "روايات",
      description: "ملحمة روائية ضخمة تروي تاريخ الكويت عبر ثلاثة أجيال، تنسج بين الماضي والحاضر في نسيج إنساني معقد يبحث عن الهوية والانتماء في عالم متغير، تمزج الواقعية بالسرد الملحمي.",
      price: 976,
      priceUSD: 23.40,
      originalPrice: 1377,
      originalPriceUSD: 33,
    ...
    },
    {
      ...
      category: "روايات",
      description: "قصة كلاسيكية ساحرة عن فتاة يتيمة تحصل على فرصة للدراسة الجامعية بدعم من راعٍ مجهول، تروي رحلتها في اكتشاف الذات والحب والأدب through رسائل مميزة تكشف تدريجياً عن هوية كاتبها الغامض.",
      price: 350,
      priceUSD: 8.40,
      originalPrice: 500,
      originalPriceUSD: 12,
    ...
    {
      id: 189,
      title: "مدن الحليب والثلج",
      category: "روايات",
      description: "عمل شعري النثر يرسم لوحات wordsية لمدن خيالية تتراقص بين الواقع والحلم، تبحث عن الجمال في التفاصيل الصغيرة وتكشف poetry الحياة اليومية في أماكن تختلط فيها الذاكرة بالخيال.",
      price: 292,
      priceUSD: 7.00,
      originalPrice: 417,
      originalPriceUSD: 10,
      discount: 30,
      image: "/book-images/Novels/Nbook184.jpg",
      author: "جليلة السيد"
    },
    {
      id: 190,
      title: "مزرعة الحيوان",
      category: "روايات",
      description: "رواية رمزية خالدة تقدم نقداً لاذعاً للثورات التي تتحول إلى ديكتاتوريات، through قصة حيوانات تثور ضد مالكها البشري ثم تكرس نظاماً أكثر قسوة، في تحفة أدبية about فساد السلطة المطلقة.",
      price: 117,
      priceUSD: 2.80,
      originalPrice: 167,
      originalPriceUSD: 4,
    ...
    },
    {
      ...
      title: "المناطيد",
      category: "روايات",
      description: "قصة عن الأحلام التي تحلق high في السماء ثم تعود إلى الأرض، تروي رحلة شخصيات تبحث عن الحرية والخلاص through السفر والترحال، في عمل يجمع بين السخرية اللاذعة والحساسية المفرطة.",
      price: 233,
      priceUSD: 5.60,
      originalPrice: 334,
      originalPriceUSD: 8,
    ...
    },
    {
      ...
      title: "وادي الفراشات",
      category: "روايات",
      description: "رحلة إلى وادي سحري تتحول فيه الفراشات إلى رموز للتحول والجمال الزائل، تروي قصة حب واستعادة الذات في مكان where يتداخل الواقع بالأسطورة والطبيعة بالإنسان.",
      price: 292,
      priceUSD: 7.00,
      originalPrice: 417,
      originalPriceUSD: 10,
      discount: 30,
      image: "/book-images/Novels/Nbook187.jpg",
      author: "أزهر جرجيس"
    },
    {
      id: 193,
      title: "الجريمة والعقاب 1/2",
      category: "روايات",
      description: "تحفة دوستويفسكي النفسية التي تغوص في أعماق الضمير البشري، تروي قصة طالب فقير يرتكب جريمة قتل ثم يعاني من عواقبها النفسية المدمرة، في دراسة عميقة about الخطيئة والخلاص والعدالة.",
      price: 730,
      priceUSD: 17.50,
      originalPrice: 1042,
      originalPriceUSD: 25,
      discount: 30,
      image: "/book-images/Novels/Nbook188.jpg",
      author: "دوستويفسكي"
    },
    {
      id: 194,
      title: "الإخوة كرامازوف 1/4",
      category: "روايات",
      description: "الجزء الأول من الملحمة الفلسفية العظيمة التي تبحث في الصراع بين الإيمان والإلحاد through قصة عائلة ممزقة بالجريمة والشهوة والصراع الأبوي، تمثل ذروة الإبداع في الأدب العالمي.",
      price: 1167,
      priceUSD: 28.00,
      originalPrice: 1667,
      originalPriceUSD: 40,
      discount: 30,
      image: "/book-images/Novels/Nbook189.jpg",
      author: "دوستويفسكي"
    },
    {
      id: 195,
      title: "البؤساء",
      category: "روايات",
      description: "ملحمة إنسانية عظيمة تتبع حياة جان فالجان من السجن إلى الخلاص، تروي معاناة الفقراء في فرنسا القرن التاسعوسط وتقدم نقداً اجتماعياً حاداً مع بحث عميق about طبيعة العدالة والرحمة والتضحية.",
      price: 350,
      priceUSD: 8.40,
      originalPrice: 500,
      originalPriceUSD: 12,
      discount: 30,
      image: "/book-images/Novels/Nbook190.jpg",
      author: "فيكتور هوغو"
    },
    {
      id: 196,
      title: "دانشمند",
      category: "روايات",
      description: "رحلة في عالم الصوفية والحكمة الشرقية، تروي قصة عالم متجول يبحث عن المعرفة والحقيقة through لقاءات مع حكماء وفلاسفة، في عمل يمزج between الروحانية والسرد القصصي الشيق.",
      price: 525,
      priceUSD: 12.60,
      originalPrice: 750,
      originalPriceUSD: 18,
      discount: 30,
      image: "/book-images/Novels/Nbook191.jpg",
    ...
    },
    {
      ...
      category: "روايات",
      description: "قصة حب شاعرية ترسم لوحة رقيقة لمشاعر الوحدة والأمل في ليالي سانت بطرسبرغ البيضاء، where يلتقي شاب خجول بفتاة غامضة في حكاية about الأحلام التي تتحطم على صخرة الواقع.",
      price: 175,
      priceUSD: 4.20,
      originalPrice: 250,
      originalPriceUSD: 6,
      discount: 30,
      image: "/book-images/Novels/Nbook192.jpg",
      author: "دوستويفسكي"
    },
    {
      id: 198,
      title: "ماجدولين",
      category: "روايات",
      description: "رواية عاطفية خالدة تروي قصة حب تراجيدية between شاب وفتاة من طبقات اجتماعية مختلفة، written بأسلوب المنفلوطي الشاعري الذي يجمع between الرقة الأدبية والعذوبة العاطفية في تحفة from الأدب الرومانسي.",
      price: 233,
      priceUSD: 5.60,
      originalPrice: 334,
      originalPriceUSD: 8,
      discount: 30,
      image: "/book-images/Novels/Nbook193.jpg",
      author: "مصطفى لطفي المنفلوطي"
    },
    {
      id: 199,
      title: "التحول",
      category: "روايات",
      description: "قصة كافكا الكابوسية about موظف عادي يتحول فجأة إلى حشرة ضخمة، تقدم استعارة مروعة about اغتراب الإنسان في المجتمع الحديث والعلاقات الأسرية المختلة، في عمل مؤسس للأدب العبثي.",
      price: 233,
      priceUSD: 5.60,
      originalPrice: 334,
      originalPriceUSD: 8,
      discount: 30,
      image: "/book-images/Novels/Nbook194.jpg",
      author: "فرانز كافكا"
    },
    {
      id: 200,
      title: "بوليانا",
      category: "روايات",
      description: "قصة كلاسيكية ملهمة about فتاة يتيمة تعلّم الجميع لعبة 'الفرح' حيث يجب إيجاد شيء لتكون سعيداً به دائماً، تقدم رسالة optimistية about قوة التفكير الإيجابي وتغيير perspective للحياة.",
      price: 525,
      priceUSD: 12.60,
      originalPrice: 750,
      originalPriceUSD: 18,
      discount: 30,
      image: "/book-images/Novels/Nbook195.jpg",
      author: "إليانور بورتر"
    },
    {
      id: 201,
      title: "زوربا اليوناني",
      category: "روايات",
      description: "رواية about الحياة والحب والحرية through قصة صداقة between مثقف بريطاني ورجل يوناني spontaneous، تقدم فلسفة existencialية في العيش بكثافة والاستمتاع بلحظة الحاضر without خوف من المستقبل.",
      price: 350,
      priceUSD: 8.40,
      originalPrice: 500,
      originalPriceUSD: 12,
      discount: 30,
      image: "/book-images/Novels/Nbook196.jpg",
      author: "نيكوس كازنتزركي"
    },
    {
      id: 202,
      title: "الحرب والسلم 1/3",
      category: "روايات",
      description: "الجزء الأول من الملحمة الروائية الأضخم في الأدب العالمي، تروي تاريخ روسيا during حروب نابليون through حياة خمس عائلات أرستقراطية، تمزج between الدراما الشخصية والأحداث التاريخية الكبرى في عمل about القدر والحب والحرب.",
      price: 700,
      priceUSD: 16.80,
      originalPrice: 1001,
      originalPriceUSD: 24,
      discount: 30,
      image: "/book-images/Novels/Nbook197.jpg",
      author: "ليو تولستوي"
    },
  ...
  },
  {
    ...
    title: "مجمع الأمثال",
    category: "الأدب",
    description: "موسوعة أدبية شاملة تجمع أمثال العرب في الجاهلية والإسلام، تعتبر من أعظم الكتب التي حفظت تراث الأمثال العربية وشرحت معانيها واستعمالاتها في مختلف السياقات الأدبية والاجتماعية.",
    price: 1201,
    priceUSD: 28.80,
    originalPrice: 2002,
    originalPriceUSD: 48,
  ...
  },
  {
    ...
    title: "العقد الفريد",
    category: "الأدب",
    description: "تحفة أدبية خالدة تجمع بين الشعر والنثر والأخبار والأمثال، تمثل ذروة الإبداع في الأدب الأندلسي وتوثق ثقافة العرب وحضارتهم عبر عصور مختلفة في عمل موسوعي فريد.",
    price: 2402,
    priceUSD: 57.60,
    originalPrice: 4003,
    originalPriceUSD: 96,
  ...
  {
    id: 76,
    title: "موسوعة هارون الرشيد",
    category: "الأدب",
    description: "عمل ضخم يوثق حياة وسيرة الخليفة العباسي الأسطوري هارون الرشيد، يقدم صورة شاملة عن عصره الذهبي من النواحي السياسية والأدبية والاجتماعية والعلمية في بغداد عاصمة العالم القديم.",
    price: 901,
    priceUSD: 21.60,
    originalPrice: 1502,
    originalPriceUSD: 36,
    discount: 40,
    image: "/book-images/Literature/Lbook78.jpg",
    author: "الدكتور سعدي ضنّاوي"
  },
  {
    id: 77,
    title: "كتاب الأغاني",
    category: "الأدب",
    description: "أضخم موسوعة أدبية في التراث العربي، تجمع بين التاريخ والأدب والموسيقى والشعر، تحكي قصص الغناء والغزَل في العصرين الأموي والعباسي وتوثق حياة الشعراء والموسيقيين في أعظم مراحل الحضارة العربية.",
    price: 6255,
    priceUSD: 150.00,
    originalPrice: 10425,
  ...
  },
  {
    ...
    title: "جنون سطحي",
    category: "الأدب",
    description: "مجموعة نصوص أدبية تبحث في تناقضات الحياة المعاصرة والعلاقات الإنسانية، تكشف عن الجنون الخفي تحت السطح الهادئ للوجود اليومي بأسلوب ساخر وعميق.",
    price: 467,
    priceUSD: 11.20,
    originalPrice: 667,
    originalPriceUSD: 16,
  ...
  },
  {
    ...
    title: "ظننته رجلا",
    category: "الأدب",
    description: "عمل أدري يجسد صراع المرأة مع التوقعات المجتمعية والصور النمطية عن الرجولة، يقدم نظرة نقدية لعلاقات القوة بين الجنسين في مجتمع يفرض أدواراً محددة مسبقاً.",
    price: 467,
    priceUSD: 11.20,
    originalPrice: 667,
    originalPriceUSD: 16,
    discount: 30,
    image: "/book-images/Literature/Lbook81.jpg",
    author: "فاتن حمّود"
  },
  {
    id: 80,
    title: "إن بعض الرجال إثم",
    category: "الأدب",
    description: "مجموعة قصصية تفضح التناقضات الأخلاقية في العلاقات العاطفية، تقدم شخصيات رجالية في مواقف تظهر الهوة بين المبادئ المعلنة والسلوك الفعلي في الحب والزواج.",
    price: 467,
    priceUSD: 11.20,
    originalPrice: 667,
    originalPriceUSD: 16,
  ...
  {
    id: 81,
    title: "قلبي في ذمة الحب",
    category: "الأدب",
    description: "رحلة عاطفية شفافة تروي تفاصيل الوقوع في الحب والارتباط والانفصال، تكشف عن هشاشة المشاعر الإنسانية وقوة التعلق في علاقات لا يمكن التنبؤ بنهاياتها.",
    price: 467,
    priceUSD: 11.20,
    originalPrice: 667,
    originalPriceUSD: 16,
  ...
  {
    id: 82,
    title: "ضحية نفسي والنفس الأمارة بالسوء",
    category: "الأدب",
    description: "تأملات وجودية في الصراع الداخلي بين نوازع الخير والشر في النفس البشرية، تبحث في كيفية تحول الإنسان إلى ضحية لرغباته وأهوائه في عالم يفتقر إلى اليقين الأخلاقي.",
    price: 467,
    priceUSD: 11.20,
    originalPrice: 667,
    originalPriceUSD: 16,
  ...
  },
  {
    ...
    title: "المرسلات",
    category: "الأدب",
    description: "عمل فلسفي عميق يقدم رؤية سبينوزا حول الطبيعة والله والحرية الإنسانية، يمزج بين المنطق الرياضي والتأمل الميتافيزيقي في بحث عن الحقيقة المطلقة.",
    price: 584,
    priceUSD: 14.00,
    originalPrice: 834,
    originalPriceUSD: 20,
  ...
  {
    id: 84,
    title: "دمشق مدينة السحر والشعر",
    category: "الأدب",
    description: "رثاء شعري ونثري لدمشق التاريخية، يصور جمال المدينة القديمة وعظمتها الحضارية وأساطيرها الشعبية، في عمل يجمع بين الذاكرة الجمعية والحنين إلى الماضي التليد.",
    price: 205,
    priceUSD: 4.90,
    originalPrice: 292,
    originalPriceUSD: 7,
  ...
  {
    id: 85,
    title: "ذكرايات الجواهري",
    category: "الأدب",
    description: "مذكرات شاعر العرب الأكبر محمد مهدي الجواهري، تروي مسيرة حياته الحافلة بالأحداث السياسية والأدبية، وتكشف عن تفاصيل نضاله الوطني وإبداعه الشعري في قرن من التغيرات الكبرى.",
    price: 1319,
    priceUSD: 31.50,
    originalPrice: 1877,
    originalPriceUSD: 45,
  ...
  },
  {
    ...
    title: "إشكالات الفلسفة السياسية",
    category: "سياسة",
    description: "عمل تأسيسي عميق يغوص في الإشكاليات المركزية التي شغلت الفلاسفة和政治يين عبر العصور، من طبيعة العدالة وشرعية السلطة إلى حدود الحرية الفردية frente للمصلحة الجماعية. يقدم تحليلاً نقدياً شاملاً للنظريات الكلاسيكية والمعاصرة مع تركيز خاص على إشكالية التوازن between الحقوق والواجبات في الدولة الحديثة.",
    price: 292,
    priceUSD: 7.00,
    originalPrice: 417,
    originalPriceUSD: 10,
    discount: 30,
    image: "/book-images/Policy/Pbook2.jpg",
    author: "ديفيد د.رفائيل"
  },
  {
    id: 3,
    title: "اللسانيات النصية",
    category: "سياسة",
    description: "دراسة رائدة تكشف عن الآليات الخفية للغة في تشكيل الخطاب السياسي والهيمنة الإيديولوجية، تبحث في كيفية استخدام الأنظمة السياسية للغة كأداة للسيطرة والترويج، من خلال تحليل بنى النصوص وخطابات الزعماء وآليات الإقناع الخفية التي تشكل الرأي العام وتوجه الوعي الجمعي.",
    price: 292,
    priceUSD: 7.00,
    originalPrice: 417,
    originalPriceUSD: 10,
    discount: 30,
    image: "/book-images/Policy/Pbook3.jpg",
    author: "محمد عبد الجليل يوسف"
  },
  {
    id: 4,
    title: "الأمير",
    category: "سياسة",
    description: "الكتاب الأكثر تأثيراً وإثارة للجدل في تاريخ الفكر السياسي، يقدم ميكافيلي نصائحه الواقعية والقاسية للحاكم حول كيفية اكتساب السلطة والاحتفاظ بها. عمل ثوري حوّل السياسة من فن المبادئ الأخلاقية إلى علم المصلحة والفعّالية، مازجاً between الواقعية السياسية والبراغماتية في حكم الدول.",
    price: 233,
    priceUSD: 5.60,
    originalPrice: 334,
    originalPriceUSD: 8,
    discount: 30,
    image: "/book-images/Policy/Pbook4.jpg",
    author: "نيقولا ميكافيلي"
  },
  {
    id: 5,
    title: "كيف يدار العالم",
    category: "سياسة",
    description: "تحليل جريح وصادم لآليات الهيمنة العالمية في العصر الحديث، يكشف تشومسكي عن الشبكة المعقدة للقوى التي تحكم العالم من خلف الكواليس - من الشركات متعددة الجنسيات إلى مراكز الأبحاث ووسائل الإعلام - وكيف تُصنع القرارات المصيرية بعيداً عن الديمقراطية وخلف ستار من السرية والتلاعب بالوعي.",
    price: 438,
    priceUSD: 10.50,
    originalPrice: 625,
    originalPriceUSD: 15,
    discount: 30,
    image: "/book-images/Policy/Pbook5.jpeg",
    author: "نعوم تشومسكي"
  },
  ...
  {
    id: 32,
    title: "اللعبة التي لا تنتهي",
    category: "تطوير ذات",
    description: "استكشاف عميق لفلسفة القيادة والإلهام في عالم الأعمال، يقدم رؤى ثورية حول بناء المنظمات التي تدوم وتؤثر من خلال التركيز على الغاية والهدف الأسمى.",
    price: 500,
    priceUSD: 12.00,
    originalPrice: 834,
    originalPriceUSD: 20,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook32.webp",
    author: "سايمون سينك"
  },
  {
    id: 33,
    title: "أحيانا تفوز أحيانا تتعلم",
    category: "تطوير ذات",
    description: "دليل ملهم لتحويل الخسائر إلى دروس قيّمة، يقدم استراتيجيات عملية لاستخلاص الحكمة من التجارب الفاشلة وتحويلها إلى وقود للنجاح المستقبلي.",
    price: 400,
    priceUSD: 9.60,
    originalPrice: 667,
    originalPriceUSD: 16,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook33.jpg",
    author: "جون سي ماكسويل"
  },
  {
    id: 34,
    title: "الانتباه للاضطرابات الشخصية الحدية",
    category: "تطوير ذات",
    description: "مرشد شامل لفهم والتعامل مع اضطراب الشخصية الحدية، يقدم أدوات عملية للتعافي وبناء حياة مستقرة مع فهم عمق للجوانب النفسية والعاطفية.",
    price: 425,
    priceUSD: 10.20,
    originalPrice: 709,
    originalPriceUSD: 17,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook34.jpg",
    author: "د. بليز أجيري & د. جيليان جالين"
  },
  {
    id: 35,
    title: "كيف تتخلص من القلق وتبدأ حياتك",
    category: "تطوير ذات",
    description: "كلاسيكية في علم النفس التطبيقي تقدم نصائح خالدة للتغلب على القلق اليومي وبناء ثقة بالنفس تمكنك من عيش حياة أكثر إنتاجية وسعادة.",
    price: 375,
    priceUSD: 9.00,
    originalPrice: 625,
    originalPriceUSD: 15,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook35.jpg",
    author: "ديل كارنجي"
  },
  {
    id: 36,
    title: "قوة الفعل القليل",
    category: "تطوير ذات",
    description: "فلسفة جديدة للنجاح تركز على تأثير الخطوات الصغيرة المتسقة، تثبت أن التقدم الحقيقي يتحقق من خلال أفعال يومية بسيطة لكن مستمرة.",
    price: 325,
    priceUSD: 7.80,
    originalPrice: 542,
    originalPriceUSD: 13,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook36.jpg",
    author: "فيرجوس أوكونيل"
  },
  {
    id: 37,
    title: "كيف تتقن فن البيع",
    category: "تطوير ذات",
    description: "دليل شامل لاحتراف فنون البيع والإقناع، يقدم تقنيات مجربة لبناء علاقات مع العملاء وإغلاق الصفقات بنجاح في أي مجال.",
    price: 350,
    priceUSD: 8.40,
    originalPrice: 584,
    originalPriceUSD: 14,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook37.webp",
    author: "توم هوبكنز"
  },
  {
    id: 38,
    title: "المريخ والزهرة في مكان العمل",
    category: "تطوير ذات",
    description: "تحليل عميق لاختلافات التواصل بين الجنسين في البيئة المهنية، يقدم حلولاً عملية لتحسين التعاون وزيادة الإنتاجية بين الزملاء.",
    price: 350,
    priceUSD: 8.40,
    originalPrice: 584,
    originalPriceUSD: 14,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook38.jpg",
    author: "د. جون جراي"
  },
  {
    id: 39,
    title: "دع المسامحة تحررك",
    category: "تطوير ذات",
    description: "رحلة شفاء نفسي تشرح كيف يمكن للمسامحة أن تكون أقوى أدوات التحرر من ألم الماضي وبناء مستقبل نفسي أكثر صحة وسلاماً.",
    price: 350,
    priceUSD: 8.40,
    originalPrice: 584,
    originalPriceUSD: 14,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook39.jpg",
    author: "ميريديث هوك"
  },
  {
    id: 40,
    title: "محاط بالانتكاسات",
    category: "تطوير ذات",
    description: "دليل واقعي للتعامل مع الفشل المتكرر، يقدم استراتيجيات لتحويل الإخفاقات إلى دروس وبناء مرونة نفسية تمكن من الاستمرار نحو النجاح.",
    price: 325,
    priceUSD: 7.80,
    originalPrice: 542,
    originalPriceUSD: 13,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook40.jpg",
    author: "توماس إريكسون"
  },
  {
    id: 41,
    title: "إيكيجاي",
    category: "تطوير ذات",
    description: "استكشاف للفلسفة اليابانية في إيجاد الغاية من الحياة، يقدم مفاتيح لاكتشاف شغفك الشخصي وعيش حياة مليئة بالمعنى والرضا.",
    price: 325,
    priceUSD: 7.80,
    originalPrice: 542,
    originalPriceUSD: 13,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook41.jpg",
    author: "هيكتور جارسيا & فرانسيس ميرالز"
  },
  {
    id: 42,
    title: "مواطن الضعف لديك",
    category: "تطوير ذات",
    description: "تحليل نفسي عميق لنقاط الضعف البشرية وكيفية تحويلها إلى مصادر قوة، يقدم رؤى ثورية في فهم الذات وتحسين العلاقات.",
    price: 325,
    priceUSD: 7.80,
    originalPrice: 542,
    originalPriceUSD: 13,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook42.jpg",
    author: "واين دبليو. داير"
  },
  {
    id: 43,
    title: "الخروج من المتاهة",
    category: "تطوير ذات",
    description: "قصة رمزية ملهمة عن إيجاد طريقك في الحياة والعمل، تقدم دروساً عميقة في اتخاذ القرارات والتغلب على التعقيدات اليومية.",
    price: 350,
    priceUSD: 8.40,
    originalPrice: 584,
    originalPriceUSD: 14,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook43.jpg",
    author: "سبنسر جونسون"
  },
  {
    id: 44,
    title: "أسرار عادات البيع",
    category: "تطوير ذات",
    description: "دليل متقدم لفنون البيع يكشف عن العادات اليومية التي تميز البائع المحترف، من بناء العلاقات إلى إتقان إقفال الصفقات.",
    price: 350,
    priceUSD: 8.40,
    originalPrice: 584,
    originalPriceUSD: 14,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook44.jpg",
    author: "توم زيجلار"
  },
  {
    id: 45,
    title: "السعادة",
    category: "تطوير ذات",
    description: "استكشاف علمي وعملي لطبيعة السعادة وكيفية cultivتها في الحياة اليومية، يقدم نماذج عملية لعيش حياة أكثر فرحاً ورضاً.",
    price: 300,
    priceUSD: 7.20,
    originalPrice: 500,
    originalPriceUSD: 12,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook45.jpg",
    author: "جيل هاوسن"
  },
  {
    id: 46,
    title: "المؤسس التائه",
    category: "تطوير ذات",
    description: "قصة ملهمة لرحلة ريادة الأعمال من الصفر، تقدم دروساً قيّمة في الابتكار والتسويق الرقمي وبناء الشركات الناجحة في العصر الحديث.",
    price: 400,
    priceUSD: 9.60,
    originalPrice: 667,
    originalPriceUSD: 16,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook46.jpg",
    author: "راند فيشكين"
  },
  {
    id: 47,
    title: "بع بالطريقة التي تشتري بها",
    category: "تطوير ذات",
    description: "ثورة في فلسفة البيع تركز على فهم psychology المشتري وتقديم الحلول التي تلبي احتياجاته الحقيقية بدلاً من مجرد بيع المنتجات.",
    price: 400,
    priceUSD: 9.60,
    originalPrice: 667,
    originalPriceUSD: 16,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook47.jpeg",
    author: "دافيد بريمير"
  },
  {
    id: 48,
    ...
    category: "تطوير ذات",
    description: "خطة عملية محكمة لتحقيق الاستقلال المالي، تقدم استراتيجيات واقعية للادخار والاستثمار وبناء الثروة على المدى الطويل.",
    price: 400,
    priceUSD: 9.60,
    originalPrice: 667,
    originalPriceUSD: 16,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook48.jpg",
    author: "جرانت سابتير"
  },
  {
    id: 49,
    title: "الجري مع الثعالب",
    category: "تطوير ذات",
    description: "استراتيجيات ذكية للتفوق في عالم الأعمال التنافسي، تقدم أفكاراً مبتكرة للتفاوض والتسويق وبناء ميزة تنافسية مستدامة.",
    price: 400,
    priceUSD: 9.60,
    originalPrice: 667,
    originalPriceUSD: 16,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook49.jpg",
    author: "بول ديرفان"
  },
  {
    id: 50,
    title: "الفشل بامتياز",
    category: "تطوير ذات",
    description: "نظرة جديدة للفشل كضرورة للنجاح، تقدم أدوات للتعلم من الأخطاء وتحويل الإخفاقات إلى فرص للنمو والتطور الشخصي والمهني.",
    price: 350,
    priceUSD: 8.40,
    originalPrice: 584,
    originalPriceUSD: 14,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook50.jpeg",
    author: "شيلي دافيدو & بول ويليامز"
  },
  {
    id: 51,
    title: "عملية الحضور",
    category: "تطوير ذات",
    description: "دليل عميق للوعي الكامل والحضور الذهني، يقدم تمارين وتقنيات للعيش في اللحظة الحالية وتطوير وعي أعلى بالذات والعالم.",
    price: 375,
    priceUSD: 9.00,
    originalPrice: 625,
    originalPriceUSD: 15,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook51.jpg",
    author: "مايكل براون"
  },
  {
    id: 52,
    title: "الكارما النقية",
    category: "تطوير ذات",
    description: "استكشاف لقوانين الكارما وتأثير الأفعال على مصير الإنسان، يقدم رؤية شاملة للعلاقة بين السلوك والنتائج في الحياة.",
    price: 350,
    priceUSD: 8.40,
    originalPrice: 584,
    originalPriceUSD: 14,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook52.jpg",
    author: "سيرغي ن.لازاريف"
  },
  {
    id: 53,
    title: "الدوامة",
    category: "تطوير ذات",
    description: "فلسفة جديدة في قانون الجذب والطاقة الكونية، تقدم أدوات عملية لجذب ما تريده في الحياة من خلال فهم قوانين الطاقة والاهتزاز.",
    price: 350,
    priceUSD: 8.40,
    originalPrice: 584,
    originalPriceUSD: 14,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook53.jpg",
  ...
  },
  {
    ...
    title: "سجون الثقافة",
    category: "تطوير ذات",
    description: "تحليل نقدي للقيود الثقافية والاجتماعية التي تمنع التطور الشخصي، يقدم رؤية لتحرير الذات من المعتقدات المحدودة والموروثات البالية.",
    price: 325,
    priceUSD: 7.80,
    originalPrice: 542,
    originalPriceUSD: 13,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook54.webp",
    author: "صالح زياد"
  },
  {
    id: 55,
    ...
    category: "تطوير ذات",
    description: "نظرة شاملة لتأثير الذكاء الاصطناعي على مستقبل العمل والحياة، يقدم استراتيجيات للتكيف والازدهار في العصر الرقمي الجديد.",
    price: 300,
    priceUSD: 7.20,
    originalPrice: 500,
    originalPriceUSD: 12,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook55.jpeg",
    author: "مجهول"
  },
  {
    id: 56,
    title: "فن التعافي",
    category: "تطوير ذات",
    description: "دليل عملي للتعافي من الصدمات والتحديات النفسية، يقدم خطوات عملية لبناء resilience نفسي والعودة أقوى بعد المحن.",
    price: 250,
    priceUSD: 6.00,
    originalPrice: 417,
    originalPriceUSD: 10,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook56.webp",
    author: "مجهول"
  },
  {
    id: 57,
    title: "مؤهل الحب",
    category: "تطوير ذات",
    description: "دراسة علمية وعملية لأسس العلاقات الصحية، تقدم مفاتيح لبناء علاقات حب دائمة من خلال فهم علم النفس العصبي للارتباط.",
    price: 300,
    priceUSD: 7.20,
    originalPrice: 500,
    originalPriceUSD: 12,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook57.webp",
    author: "ستان تاتكين"
  },
  {
    id: 58,
    title: "فن التركيز والانجاز",
    category: "تطوير ذات",
    description: "دليل متكامل لإتقان التركيز وتحقيق الإنجازات الكبيرة، يقدم استراتيجيات للتغلب على المشتتات وإدارة الطاقة الذهنية بشكل فعال.",
    price: 300,
    priceUSD: 7.20,
    originalPrice: 500,
    originalPriceUSD: 12,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook58.webp",
    author: "ديمون زهاريادس"
  },
  {
    id: 59,
    title: "صباح استثنائي كل يوم",
    category: "تطوير ذات",
    description: "روتين صباحي مصمم لبدء كل يوم بطاقة إيجابية عالية، يقدم عادات يومية بسيطة تحول الحياة وتزيد الإنتاجية والسعادة.",
    price: 300,
    priceUSD: 7.20,
    originalPrice: 500,
    originalPriceUSD: 12,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook59.webp",
    author: "ديمون زهاريادس"
  },
  {
    id: 60,
    title: "فن التأثير في الآخرين",
    category: "تطوير ذات",
    description: "تقنيات متقدمة للإقناع والتأثير الإيجابي، تقدم أساليب لبناء نفوذ شخصي وكسب ثقة واحترام الآخرين في جميع مجالات الحياة.",
    price: 300,
    priceUSD: 7.20,
    originalPrice: 500,
    originalPriceUSD: 12,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook60.webp",
    author: "باتريك كينغ"
  },
  {
    id: 61,
    ...
    category: "تطوير ذات",
    description: "ثورة في مفهوم اللطافة والحدود الشخصية، يقدم أدوات لقول لا وحماية الطاقة الشخصية وبناء علاقات صحية متوازنة.",
    price: 400,
    priceUSD: 9.60,
    originalPrice: 667,
    originalPriceUSD: 16,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook61.jpg",
    author: "ديوك روبنسون"
  },
  {
    id: 62,
    title: "12 قاعدة للحياة",
    category: "تطوير ذات",
    description: "دليل فلسفي عميق للحياة المعاصرة، يقدم قواعد أساسية للتعامل مع الفوضى و finding معنى في عالم معقد ومتغير باستمرار.",
    price: 450,
    priceUSD: 10.80,
    originalPrice: 750,
    originalPriceUSD: 18,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook62.webp",
  ...
  },
  {
    ...
    category: "تطوير ذات",
    description: "كلاسيكية الاستثمار التي غيرت مفهوم التداول في الأسواق المالية، تقدم مبادئ خالدة للاستثمار القيمي والتحليل المالي المحافظ.",
    price: 1050,
    priceUSD: 25.20,
    originalPrice: 1750,
    originalPriceUSD: 42,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook63.jpg",
    author: "بنيامين جراهام"
  },
  {
    id: 64,
    title: "الكتاب الذي تتمنى لو قرأه أبواك",
    category: "تطوير ذات",
    description: "مرشد عملي للتربية الواعية والصحة النفسية العائلية، يقدم رؤى جديدة لبناء علاقات أسرية صحية وتجاوز الإرث النفسي السلبي.",
    price: 400,
    priceUSD: 9.60,
    originalPrice: 667,
    originalPriceUSD: 16,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook64.jpg",
    author: "فيليبا بيري"
  },
  {
    id: 65,
    ...
    category: "تطوير ذات",
    description: "أشهر كتاب في تطوير الذات على مر العصور، يقدم مبادئ خالدة لتحسين العلاقات الشخصية والمهنية وكسب احترام وتأييد الآخرين.",
    price: 250,
    priceUSD: 6.00,
    originalPrice: 417,
    originalPriceUSD: 10,
    discount: 40,
    image: "/book-images/Self-dev/Sdbook65.jpg",
    author: "ديل كارنيجي"
  }
 ];
